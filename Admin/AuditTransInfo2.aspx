                  ...
                  <div class="card-body d-flex justify-content-between flex-column">
                    <div class="row">
                      ...
                      <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-6 col-lg-6">
                        ...
                        <asp:CompareValidator ID="cmpVal" ControlToCompare="txtFDate" ControlToValidate="txtTDate"
                          Display="Dynamic" CssClass="red" Type="Date" Operator="GreaterThan"
                          ErrorMessage="To Date should be greater than From Date" runat="server"></asp:CompareValidator>
                      </div>
                    </div>
                    ...
                    <div class="table-responsive mb-1">
                      <asp:GridView ID="gvDept"
                        CssClass="table table-row-bordered table-row-gray-300 border-0 gy-2 mb-1" runat="server"
