<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupDays.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupDays" %>
          ...
          <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
              ...
              <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-dark">Permit Validity Period</li>
              </ul>
              <!--end::Breadcrumb-->
            </div>
            <!--end::Info-->
                  ...
                  <div class="card-body d-flex justify-content-between flex-column">
                    <div class="row">
                      <div class="form-group row mx-0 mb-3 align-items-sm-center">
                        <label class="col-auto ps-0 label-100px">Valid Duration:</label>

                        <div class="input-group col-sm-8 col-md-6 col-xl-4 px-0">
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="rfvDays" CssClass="red"
                          ControlToValidate="txtDays" Display="Dynamic" ErrorMessage="Please enter number of days">
                        ...
                        <asp:RegularExpressionValidator runat="server" ID="revDays" CssClass="red"
                          ...
                          ErrorMessage="Please enter valid days"> </asp:RegularExpressionValidator>
                      </div>
                    </div>
                    ...
                    <div class="form-group mb-3 d-flex justify-content-end">
                      ...
                      <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnDelete" runat="server"
                        ...
                        OnClientClick="return confirm('Are you sure want to delete permit days?');" Text="Delete"
                    ...
                    <div id="table__responsive_Wrapper">
                      <asp:GridView ID="gvDept"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="Valid_Days" HeaderText="Permit Days" />
