...
var backgroundColor = [
  ...
  "rgba(255, 0, 0, 0.785)",
  "rgba(55, 95, 44, 0.785)",
  "rgba(22, 114, 180, 0.785)",
  // "rgba(171, 164, 168, 0.785)",
  "rgba(19, 173, 142, 0.785)",
  "rgba(37, 234, 80, 0.785)",
];
var hoverBackgroundColor = [
  ...
  "rgba(255, 0, 0, 0.85)",
  "rgba(55, 95, 44, 0.85)",
  "rgba(22, 114, 180, 0.85)",
  // "rgba(171, 164, 168, 0.85)",
  "rgba(19, 173, 142, 0.85)",
  "rgba(37, 234, 80, 0.85)",
];
...
if ($('#applicationStatusCanvas').length != 0) {
  var applicationStatusPieChart = chartInit(
...
if ($('#appTransporterStatusCanvas').length != 0) {
  var appTransporterStatusPieChart = chartInit(
    "appTransporterStatusCanvas",
...
var appByDesignationStatusData = {
  datasets: [{
    borderWidth: 0.25,
    weight: 0.8,
    backgroundColor: backgroundColor,
...
if ($('#appByDesignationStatusCanvas').length != 0) {
  var appByDesignationStatusBarChart = chartInit(
    "appByDesignationStatusCanvas",
    appByDesignationStatusData,
    "bar"
  );
}
