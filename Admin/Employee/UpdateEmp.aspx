<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateEmp.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.UpdateEmp" %>
          ...
          <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="form-group row mx-0 mb-3 align-items-md-center col-lg-12">
                <label class="col-auto ps-0 label-135px">Full Name</label>
                    <asp:TextBox CssClass="form-control col-sm-10 col-md-8 col-lg-7" runat="server" ID="txtFullName" MaxLength="200"></asp:TextBox>
            ...
            <tr runat="server" id="trws" visible="false">
                <td>
                    <div class="form-group row mx-0 mb-3 align-items-md-center col-lg-12">
                        ...
                        <asp:TextBox CssClass="form-control col-sm-10 col-md-8 col-lg-7" runat="server" ID="txtWorkstation" MaxLength="200"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" ID="rfvWorkstation" CssClass="red" ControlToValidate="txtWorkstation" Display="Dynamic" ErrorMessage="Please enter workstation name"></asp:RequiredFieldValidator>
                    </div>
            ...
            <div class="form-group row mx-0 mb-3 align-items-md-center col-lg-12">
                <label class="col-auto ps-0 label-135px">Department</label>
                    ...
                    <asp:RequiredFieldValidator runat="server" InitialValue="0" CssClass="red" ID="rfvDepartment" Visible="true" ControlToValidate="ddlDepartment" Display="Dynamic" ErrorMessage="Please select department"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group row mx-0 mb-3 align-items-md-center col-lg-12">
                ...
                <div class="form-group row mx-0 mb-3 align-items-md-center col-lg-12">
                    ...
                    <asp:TextBox CssClass="form-control col-sm-10 col-md-8 col-lg-7" runat="server" ID="txtWork" MaxLength="20"></asp:TextBox>
