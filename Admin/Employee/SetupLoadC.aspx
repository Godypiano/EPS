<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupLoadC.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.SetupLoadC" %>
    ...
    <div
        ...
        <div
            ...
            <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-dark">Load Categories</li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
        <!--end::Info-->
                    ...
                    <div
                        ...
                        <div class="row">
                            <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-12">
                                <label class="col-auto ps-0 label-115px">Load Cagtegory</label>
                                <asp:TextBox CssClass="form-control col-sm-12 col-md-8 col-xl-6" runat="server" ID="txtVeh" MaxLength="100"></asp:TextBox>
                                <asp:RequiredFieldValidator runat="server" ID="rfvVeh" CssClass="red" ControlToValidate="txtVeh" Display="Dynamic" ErrorMessage="Please enter load category"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group mb-3 d-flex justify-content-end">
                            ...
                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnDelete" runat="server" CausesValidation="false" OnClientClick="return confirm('Are you sure want to delete category?');" Text="Delete" OnClick="btnDelete_Click" />
                        ...
                        <div class="table-responsive mb-1">
                            <asp:GridView ID="gvDept" CssClass="table table-row-bordered table-row-gray-300 border-0 gy-2 mb-1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LoadC_Name" HeaderText="Category " />
