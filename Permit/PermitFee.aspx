<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermitFee.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Permit.PermitFee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <table style="width: 100%;">
            <tr>
                <td class="frmhdrs" height="50px" align="center" colspan="2"
                    style="background-color: #889cb1; color: #fff;">
                    <b>
                        <asp:Label runat="server" ID="lbl_ALPS">ABNORMAL LOAD PERMIT SYSTEM</asp:Label>
                    </b>
                    <br />
                    <b>
                        <asp:Label runat="server" ID="lbl_Permit_Fee">Permit Fee</asp:Label>
                    </b>
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td style="width: 90%;">
                    <asp:GridView ID="gvSurcharge"
                        ...
                        PageSize="10" AllowPaging="true" OnRowDataBound="schRowDataBound">
            ...
            <tr>
                ...
                <td style="width: 90%;">
                    <asp:GridView ID="gvGVM"
                        ...
                        runat="server" AutoGenerateColumns="false" Width="100%"
                        AlternatingRowStyle-CssClass="AlternateItemStyle" HeaderStyle-CssClass="HeaderDatagrid"
                        PageSize="10" OnRowDataBound="gvmRowDataBound" AllowPaging="true">
                        <RowStyle HorizontalAlign="Left" CssClass="FirstItemStyle" />
                        <PagerStyle CssClass="gridViewPager" />
                        <Columns>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width:30%;">
                    <asp:Label runat="server" ID="lblTotal_PerFee">Total Permit Fee</asp:Label>: <asp:Label
                        runat="server" ID="lblTF"></asp:Label>
                </td>
                <td style="width:25%;">
                    <table style="width:100%; border:1px solid black;">
                        ...
                        <tr>
                            ...
                            <td style="width:62%;">
                                <asp:Label runat="server" ID="lblApp" Visible="false"></asp:Label>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td style="width:5%;"></td>
                <td style="width: 90%;">
                    <asp:Label runat="server" ID="lblcnttxt">Control No: </asp:Label>
                    <asp:Label runat="server" ID="lblcnt"></asp:Label><br /><br />
                    <asp:Label runat="server" ID="lbl_RefNo">Your Reference No</asp:Label>: <asp:Label runat="server"
                        ID="iRef"></asp:Label><br /><br />
                    <asp:Label runat="server" ID="lbl_One">One</asp:Label> USD = <asp:Label runat="server" ID="lblUSD">
                    </asp:Label> TZS <asp:Label runat="server" ID="lbl_AsOn">as on</asp:Label>
                    <asp:Label runat="server" ID="lblDate"></asp:Label><br /><br />
                    <asp:Label runat="server" ID="lbl_Total_Permit_Fee">Total Permit Fee</asp:Label> = <asp:Label
                        runat="server" ID="lbltot"></asp:Label> X
                    <asp:Label runat="server" ID="lbltzs"></asp:Label> TZS = <asp:Label runat="server" ID="lbltottzs">
                    </asp:Label> TZS
