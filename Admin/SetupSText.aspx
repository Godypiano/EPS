<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupSText.aspx.cs"
    ValidateRequest="false" MasterPageFile="~/Default_admin.Master"
    Inherits="PresentationLayer.Admin.SetupSText" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">SMS Text
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        <div
                                            class="form-group mx-0 mb-3 col-sm-12 col-md-9 col-lg-7">
                                            <label class="col-auto ps-0">
                                                Select Flow</label>
                                            <asp:DropDownList CssClass="form-control col-sm-12" runat="server"
                                                ID="ddlFlow" AutoPostBack="true"
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ID="rfvFlow" CssClass="red"
                                                Display="Dynamic" ErrorMessage="Please select flow"
                                        ...
                                        <div
                                            ...
                                            <asp:TextBox CssClass="form-control col-sm-12" runat="server" ID="txtDays"
                                        ...
                                        <div class="form-group mb-3 d-flex justify-content-end">
                                            ...
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                ID="btnDelete" Visible="false" runat="server" CausesValidation="false"
                                        ...
                                        <div id="table__responsive_Wrapper">
                                            <asp:GridView ID="gvDept"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="E_Text" HeaderText="SMS Text" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                    </div>
