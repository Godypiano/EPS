<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditAxles.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.AuditAxles" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div
                        ...
                        <div
                            ...
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Axles
                                        ...
                                        <div id="table__responsive_Wrapper">
                                            <asp:GridView ID="gvDept"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Gvm_Cal_Sno" HeaderText="SNO" />
                                                    <asp:BoundField DataField="Vehicle_Type" HeaderText="Vehicle Name" />
                                                    <asp:BoundField DataField="Axel_Configuration" HeaderText="Axel Configuration" />
                                                    <asp:BoundField DataField="No_Axels" HeaderText="No of Axels" />
                                                    <asp:BoundField DataField="Total_GVM" HeaderText="Total GVM" />
