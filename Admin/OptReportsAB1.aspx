<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OptReportsAB1.aspx.cs" MasterPageFile="~/Default_admin.Master"
    Inherits="PresentationLayer.Admin.OptReportsAB1" %>
                                ...
                                <div class="card-body d-flex justify-content-between flex-column">
                                    ...
                                    <div class="row">
                                        <div class="form-group row mx-0 mb-3 align-items-sm-center col-lg-6">
                                            ...
                                            <div class="col-sm-9 col-md-7 col-lg-12 col-xl-10 px-0">
                                                <div class="input-group">
                                                    ...
                                                    ControlToValidate="ALPTextBox1" Type="date" Operator="LessThanEqual" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mx-0 mb-3 align-items-sm-center col-lg-6">
                                            ...
                                            <div class="col-sm-9 col-md-7 col-lg-12 col-xl-10 px-0">
                                                <div class="input-group">
                                                    <asp:TextBox CssClass="form-control" ID="ALPTextBox2"
                                                ...
                                                ControlToValidate="ALPTextBox2" Display="Dynamic" CssClass="red"
