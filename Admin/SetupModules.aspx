<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupModules.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupModules" %>
            ...
            <ContentTemplate>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 2%;"></td>
                        <td style="width: 96%;">
                            <a class="navigationbar" href="Dashboard.aspx">Home</a>&nbsp; &gt;&gt; &nbsp;<a class="navigationbar" href="SetupModules.aspx">Modules</a>
                            </td>
                        <td style="width: 2%;"></td>
                    </tr>
                    <tr>
                ...
                <table style="width: 100%;">
                 ...
                 <table style="width: 100%;">
                     ...
                     <tr>
                        ...
                        <td style="width: 25%;">
                            <asp:TextBox runat="server" ID="txtname" MaxLength="100" Width="150"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvname" CssClass="red" ControlToValidate="txtname" Display="Dynamic" ErrorMessage="Please enter name"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                     <tr>
                        ...
                        <td colspan="2" style="width: 98%; text-align: center;">
                            <asp:GridView ID="gvDept" Style="border-width: 0px; border-style: None; width: 100%; border-collapse: collapse;"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Module_Status" HeaderText="Status" />
                                </Columns>
                            </asp:GridView>
                        </td>
                        <td style="width: 2%;"></td>
