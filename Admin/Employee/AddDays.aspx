<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDays.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.AddDays" %>
            ...
            <div class="toolbar" id="kt_toolbar">
                <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                    ...
                    <div
                        ...
                        <h1 class="text-dark fw-bolder my-1 fs-2">
                            <asp:Label runat="server" ID="lbldesi" CssClass="hd1"></asp:Label>Add Permit Days
              <small class="text-muted fs-6 fw-normal ms-1"></small>
                        ...
                        <ul class="breadcrumb fw-bold fs-base my-1">
                            ...
                            <li class="breadcrumb-item text-breadcrumbs">
                                <a href="Days.aspx" class="text-breadcrumbs text-hover-primary">Permit Days</a>
                            </li>
                            <li class="breadcrumb-item text-dark">Add Permit Days</li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    <!--end::Info-->
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div
                                    ...
                                    <div class="form-group row mx-0 mb-3 align-items-md-center">
                                        <label class="col-auto ps-0">Add Permit Valid Days</label>
