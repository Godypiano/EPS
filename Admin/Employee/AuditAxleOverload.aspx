<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditAxleOverload.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.AuditAxleOverload" %>
          ...
          <div class="toolbar" id="kt_toolbar">
            <div
                ...
                <div
                    ...
                    <!--begin::Title-->
                    <h1 class="text-dark fw-bolder my-1 fs-2"> <asp:Label runat="server" ID="lbldesi" CssClass="hd1"></asp:Label>Axles Overload
                            ...
                            <div
                                ...
                                <div class="table-responsive mb-1">
                                    <asp:GridView ID="gvDept" CssClass="table table-row-bordered table-row-gray-300 border-0 gy-2 mb-1"
                                        ...
                                        HeaderStyle-CssClass="HeaderDatagrid" OnRowDataBound="gvRowDataBound" PageSize="10" OnPageIndexChanging="gvDept_PageIndexChanging" AllowPaging="true">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Over_Charg_Sno" HeaderText="SNO" />
                                            <asp:BoundField DataField="Over_Weight_From" HeaderText="Over Weight From" />
                                            <asp:BoundField DataField="Over_Weight_To" HeaderText="Over Weight To" />
