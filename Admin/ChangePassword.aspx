<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.ChangePassword" %>
...
<div class="toolbar" id="kt_toolbar">
    <div
        ...
        <div
            ...
            <!--begin::Title-->
            <h1 class="text-dark fw-bolder my-1 fs-2">Change Password
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div
                        ...
                        <tr runat="server" id="trexpire" visible="false">
                            ...
                            <div class="form-group row mx-0 mb-3 align-items-md-center col-lg-8">
                                <label class="col-auto ps-0 label-170px">Current Password
                                    <span class="red">*</span>
                                </label>
                                <asp:TextBox CssClass="form-control col-12 col-md-10" runat="server" ID="txtCurrent" TextMode="Password" MaxLength="100"></asp:TextBox>
                            ...
                            <div class="form-group row mx-0 mb-3 align-items-md-center col-lg-8">
                                ...
                                <asp:TextBox CssClass="form-control col-12 col-md-10" runat="server" ID="txtPass" TextMode="Password" MaxLength="100"></asp:TextBox>
                            ...
                            <div class="form-group row mx-0 mb-3 align-items-md-center col-lg-8">
                                ...
                                <asp:TextBox CssClass="form-control col-12 col-md-10" runat="server" ID="txtConfirm" TextMode="Password" MaxLength="100"></asp:TextBox>
