<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupVTypes.aspx.cs"
MasterPageFile="~/Default_admin.Master"
Inherits="PresentationLayer.Admin.SetupVTypes" %> <%@ MasterType
          ...
          >
            ...
            >
              ...
              <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-dark">Vehicles</li>
              </ul>
              <!--end::Breadcrumb-->
            </div>
            <!--end::Info-->
            ...
            <div class="row g-xl-8">
              ...
              <div class="col-xl-12">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                  ...
                  >
                    <div
                      class="form-group row mx-0 mb-3 align-items-md-center"
                    >
                      <label class="col-auto ps-0 label-100px"
                        >Vehicle Name:</label
                      >
                      <asp:TextBox
                        CssClass="form-control col-sm-11 col-md-8 col-lg-7 col-xl-6"
                        runat="server"
                        ID="txtVeh"
                        MaxLength="100"
                      ></asp:TextBox>
