<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VASchedules.aspx.cs" MasterPageFile="~/Default_custom.Master"
    Inherits="PresentationLayer.Admin.Employee.VASchedules" %>
                                        ...
                                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                                            ...
                                            <div class="card-body d-flex justify-content-between flex-column">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                        <label class="col-auto ps-0 label-165px">Application
                                                            Number</label>

                                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                                            <asp:TextBox ID="txtApp" CssClass="form-control"
                                                                runat="server" Enabled="false"></asp:TextBox>
                                                            <asp:RequiredFieldValidator runat="server" ID="rfvApp"
                                                                Display="Dynamic" ControlToValidate="txtApp"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="input-group col-sm-12 col-md-12 col-xl-12 px-0">
                                                            <asp:TextBox CssClass="form-control" ID="txtFDate"
                                                                runat="server" Enabled="false"></asp:TextBox>
                                                            <div class="input-group-append rounded-left-0">
                                                                <asp:ImageButton CssClass="input-group-text"
                                                                    runat="server" CausesValidation="false" ID="iPopup"
                                                    ...
                                                    <div
                                                        class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                        <label class="col-auto ps-0 label-165px">Travel Time From (24
                                                            hours, Ex: 12:30)</label>

                                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                                            <asp:TextBox CssClass="form-control" runat="server"
                                                                ID="txtTFrom" MaxLength="5">
                                                            </asp:TextBox>
                                                    ...
                                                    <div
                                                        class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                        <label class="col-auto ps-0 label-165px">Travel Time To (24
                                                            hours, Ex: 18:30)</label>

                                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                                            <asp:TextBox CssClass="form-control" runat="server"
                                                                ID="txtTTo" MaxLength="5">
                                                            </asp:TextBox>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                                            ...
                                                            <asp:RegularExpressionValidator runat="server"
                                                                ID="revDistance" ValidationExpression="^[0-9]+$"
                                                                ControlToValidate="txtDistance" Display="Dynamic"
                                                ...
                                                <div class="table-responsive mb-1">
                                                    <asp:GridView ID="gvDept"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Permit_NO" HeaderText="SNO"
                                                                ShowHeader="false">
                                                            ...
                                                            <asp:BoundField DataField="Travel_To"
                                                                HeaderText="Travel To" />
