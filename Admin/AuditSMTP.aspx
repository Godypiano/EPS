<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSMTP.aspx.cs"
MasterPageFile="~/Default_admin.Master"
Inherits="PresentationLayer.Admin.AuditSMTP" %> <%@ MasterType
                    ...
                    <div id="table__responsive_Wrapper">
                      <asp:GridView ID="gvDept"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="From_Address" HeaderText="From Address" />
