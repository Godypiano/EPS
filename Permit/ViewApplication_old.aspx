<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewApplication_old.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Permit.ViewApplication_old" %>
            ...
            <ContentTemplate>
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="width: 5%;"></td>
                        <td style="width: 90%;">
                            <label class="hd1">View Apply Applications</label>
                            </td>
                        <td style="width: 5%;"></td>
                     </tr>
                    <tr>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 20%; text-align:right">
                            <asp:LinkButton runat="server" Visible="false" OnClientClick="return confirm('Are you sure want to modify permit details?');" ID="lnkModify" OnClick="lnkModify_Click">Modify Permit</asp:LinkButton>
                         </td>
                        <td style="width: 10%;"></td>
                    </tr>
                    </table>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%;">
                            <asp:LinkButton runat="server" ID="lnkImages" OnClick="lnkImages_Click"></asp:LinkButton>
                        </td>
                        <td style="width: 10%;"></td>
                    </tr>
                    <tr>
                    ...
                    <tr runat="server" id="trWeight" visible="false">
                        ...
                        <td style="width: 50%;">
                            <asp:LinkButton runat="server" ID="lnkTan" OnClick="lnkTan_Click"></asp:LinkButton>
                        </td>
                        <td style="width: 10%;"></td>
                    </tr>
                    ...
                    <tr runat="server" id="trPolice" visible="false">
                        ...
                        <td style="width: 50%;">
                            <asp:LinkButton runat="server" ID="lnkPolice" OnClick="lnkPolice_Click" />
                        </td>
                        <td style="width: 10%;"></td>
                    </tr>
                    ...
                    <tr runat="server" id="trTanesco" visible="false">
                        ...
                        <td style="width: 50%;">
                            <asp:LinkButton runat="server" ID="lnkTanesco" OnClick="lnkTanesco_Click" />
                        </td>
                        <td style="width: 10%;"></td>
                    </tr>
                    ...
                    <tr runat="server" id="trRoute" visible="false">
                        ...
                        <td style="width: 50%;">
                            <asp:LinkButton runat="server" ID="lnkRoute" OnClick="lnkRoute_Click" />
                        </td>
                        <td style="width: 10%;"></td>
                    </tr>
                    ...
                    <tr runat="server" id="trAdvg" visible="false">
                        ...
                        <td style="width: 50%;">
                            <asp:LinkButton runat="server" ID="lnkAdvg" OnClick="lnkAdvg_Click" />
                        </td>
                        <td style="width: 10%;"></td>
                    </tr>
