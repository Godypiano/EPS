<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermitVehiclesHW.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.PermitVehiclesHW" %>
 ...
 <div class="toolbar" id="kt_toolbar">
    <div
        ...
        <div
            ...
            <!--begin::Title-->
            <h1 class="text-dark fw-bolder my-1 fs-2">List of Permit Vehicles Length
            ...
            <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-dark">Permit Vehicles Length</li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
        <!--end::Info-->
                            ...
                            <asp:GridView ID="gvDept" CssClass="table table-row-bordered table-row-gray-300 border-0 gy-2 mb-1"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo">
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="lnkView" Text='<%#Eval("SNO") %>' OnClick="lnkView_Click"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Vehicle_Name" HeaderText="Vehicle Name" />
                                    <asp:BoundField DataField="H_W_From" HeaderText="Vehicle Height" />
                                    <asp:BoundField DataField="H_W_To" HeaderText="Vehicle Width" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
