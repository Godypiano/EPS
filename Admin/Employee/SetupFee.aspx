<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupFee.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.SetupFee" %>
            ...
            >
              <div class="row">
                <div class="form-group row mx-0 mb-3 align-items-sm-center">
                    ...
                    <div class="input-group col-sm-8 col-md-7 col-lg-8 col-xl-5 px-0" >
                        <asp:TextBox CssClass="form-control" ID="txtDays" MaxLength="100" runat="server"></asp:TextBox>
                        <div class="input-group-append rounded-left-0">
                          <span class="input-group-text">USD</span>
                        </div>
                      </div>
              
                    <asp:RequiredFieldValidator runat="server" ID="rfvDays" CssClass="red" ControlToValidate="txtDays" Display="Dynamic" ErrorMessage="Please enter permit fees"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator runat="server" ID="revDays" CssClass="red" ValidationExpression="^[0-9]{1,3}$"
              ...
              <div class="form-group mb-3 d-flex justify-content-end">
                <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnSubmit" runat="server" Text="Create" OnClick="btnSubmit_Click" />
                            ...
                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnDelete" runat="server" CausesValidation="false" OnClientClick="return confirm('Are you sure want to delete permit fee?');" Text="Delete" OnClick="btnDelete_Click" />
