<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Permit.Dashboard" %>
                    ...
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            ...
                            <h1 class="text-dark fw-bolder my-1 fs-2">
                                <asp:Label runat="server" ID="lblDh" CssClass="hd1">
                                    Dashboard </asp:Label> - <asp:Label runat="server" ID="lblDv" CssClass="hd1">View
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div id="dashoboard__chart" class="mb-5">
                                            <asp:CHART id="chTrans" runat="server" Palette="BrightPastel"
                                                BackColor="#D3DFF0" Height="396px" Width="712px"
                                                ...
                                                <legends>
                                                    <asp:Legend TitleFont="Microsoft Sans Serif, 8pt, style=Bold"
                                                        ...
                                                        Font="Trebuchet MS, 8pt, style=Bold" IsTextAutoFit="False"
                                                        Name="Default">
                                                    </asp:Legend>
                                                </legends>
                                                <borderskin SkinStyle="Emboss"></borderskin>
                                                <series>
                                                    <asp:Series ChartArea="Area1" XValueType="Double" Name="Series1"
                                                        ...
                                                        Color="180, 65, 140, 240" YValueType="Double">
                                                        <EmptyPointStyle IsValueShownAsLabel="false"
                                                            IsVisibleInLegend="false" />
                                                        <points>
                                                            <asp:DataPoint LegendText="In Process"
                                                                CustomProperties="OriginalPointIndex=1" />
                                                            <asp:DataPoint LegendText="Permit Received"
                                                                CustomProperties="OriginalPointIndex=2" />
                                                            <asp:DataPoint LegendText="Awating Permit"
                                                                CustomProperties="OriginalPointIndex=3" />
                                                            <asp:DataPoint LegendText="Awating Payment"
                                                                CustomProperties="OriginalPointIndex=5" />
                                                            <asp:DataPoint LegendText="Return to Applicant"
                                                                CustomProperties="OriginalPointIndex=6" />
                                                        </points>
                                                    </asp:Series>
                                                </series>
                                                <chartareas>
                                                    <asp:ChartArea Name="Area1" BorderColor="64, 64, 64, 64"
                                                        ...
                                                        <area3dstyle PointGapDepth="900" Rotation="162"
                                                            IsRightAngleAxes="False" WallWidth="25"
                                                            IsClustered="False" />
                                        ...
                                        <div class="dashboard__links row">
                                            <div class="dashboard__link-item col-6 col-md-2">
                                            ...
                                            <div class="dashboard__link-item col-6 col-md-2">
                                                <div class="counter_link counter_khaki">
                                                    <asp:Label runat="server" ID="lblra"></asp:Label>
                                                </div>
                                                <div class="counter_title">
                                                    <asp:Label runat="server" ID="lblIRA">Return to Applicant
                                                    </asp:Label>
                                                </div>
                                            </div>

                                            <div class="dashboard__link-item col-6 col-md-2">
                                                <div class="counter_link counter_brown">
                                                    <asp:Label runat="server" ID="lblapay"></asp:Label>
                                                </div>
                                                <div>
                                                    <asp:Image runat="server" ID="imgNew1"
                                                        ImageUrl="/Images/new_blink.gif" Visible="false" />
                                                </div>
                                                <div class="counter_title">
                                                    <asp:Label runat="server" ID="lblAPayment">Awating Payment
                                                    </asp:Label>
                                                </div>
                                            </div>

                                            <div class="dashboard__link-item col-6 col-md-2">
                                                <div class="counter_link counter_lightblue">
