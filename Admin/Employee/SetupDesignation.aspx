<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupDesignation.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.SetupDesignation" %>
            ...
            >
              <div class="row">
                <div class="form-group row mx-0 mb-3 align-items-sm-center">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="rfvVeh" CssClass="red" ControlToValidate="txtVeh" Display="Dynamic" ErrorMessage="Please enter designation name"></asp:RequiredFieldValidator>
              ...
              <div class="form-group mb-3 d-flex justify-content-end">
                <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnSubmit" runat="server" Text="Create" OnClick="btnSubmit_Click" />
                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnUpdate" runat="server" Text="Update" Visible="false" OnClick="btnUpdate_Click" />
                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnDelete" runat="server" CausesValidation="false" Visible="false" OnClientClick="return confirm('Are you sure want to delete designation name?');" Text="Delete" OnClick="btnDelete_Click" />
