<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAxel.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.AddAxel" %>
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div
                            ...
                            <div class="form-group row mx-0 mb-3 align-items-md-center">
                                ...
                                <asp:DropDownList CssClass="form-control col-md-7 col-lg-6" runat="server" ID="ddlCargo"></asp:DropDownList>
                            ...
                            <div class="form-group row mx-0 mb-3 align-items-md-center">
                                ...
                                <asp:TextBox CssClass="form-control col-md-7 col-lg-6" runat="server" ID="txtAC" AutoPostBack="true" MaxLength="200" OnTextChanged="txtAC_TextChanged"></asp:TextBox>
                            ...
                            <div class="form-group row mx-0 mb-3 align-items-md-center">
                                ...
                                <asp:TextBox CssClass="form-control col-md-7 col-lg-6" runat="server" ID="txtNA" MaxLength="20" Enabled="false"></asp:TextBox>
