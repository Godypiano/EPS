<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupPermitV.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupPermitV" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Permit Vehicle
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div class="row">
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-10 col-lg-10 col-xl-6">
                                                <label class="col-auto ps-0 label-215px">Vehicle Type/Name:</label>
                                                <asp:TextBox CssClass="form-control col-sm-12" runat="server"
                                                    ID="txtVehicle" MaxLength="100"></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvVehicle"
                                                    CssClass="red" ControlToValidate="txtVehicle" Display="Dynamic"
                                            ...
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-10 col-lg-10 col-xl-6">
                                                <label class="col-auto ps-0 label-215px">Total Vehicle Registration
                                                    Number:</label>
                                                <asp:TextBox CssClass="form-control col-sm-12" runat="server" ID="txtNR"
                                                    MaxLength="20"></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvNR" CssClass="red"
                                                    ControlToValidate="txtNR" Display="Dynamic"
                                                    ErrorMessage="Please enter registration number count">
                                                </asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator runat="server" ID="revNR" CssClass="red"
                                                    ValidationExpression="^[1-9]{1}$" ControlToValidate="txtNR"
                                                    Display="Dynamic"
                                                    ErrorMessage="Please enter valid registration count">
                                                </asp:RegularExpressionValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div id="table__responsive_Wrapper">
                                            <asp:GridView ID="gvDept"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Vehicle_Name"
                                                        HeaderText="Vehicle Name" />
                                                    <asp:BoundField DataField="Vehicle_SNO" HeaderText="Department ID"
                                                        ShowHeader="false">
                                                        <ItemStyle CssClass="hide" />
                                                        <HeaderStyle CssClass="hide" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="NO_Registrations"
                                                        HeaderText="Number of Registrations" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                    </div>
