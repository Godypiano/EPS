<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupDays.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.SetupDays" %>
    ...
    >
      ...
      >
        ...
        <ul class="breadcrumb fw-bold fs-base my-1">
          ...
          <li class="breadcrumb-item text-dark">Permit Days</li>
        </ul>
        <!--end::Breadcrumb-->
      </div>
      <!--end::Info-->
            ...
            >
              <div class="row">
                <div class="form-group row mx-0 mb-3 align-items-sm-center">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="rfvDays" CssClass="red" ControlToValidate="txtDays" Display="Dynamic" ErrorMessage="Please enter number of days"></asp:RequiredFieldValidator>
              ...
              <div class="form-group mb-3 d-flex justify-content-end">
                <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnSubmit" runat="server" Text="Create" OnClick="btnSubmit_Click" />
                            ...
                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnDelete" runat="server" CausesValidation="false" OnClientClick="return confirm('Are you sure want to delete permit days?');" Text="Delete" OnClick="btnDelete_Click" />
