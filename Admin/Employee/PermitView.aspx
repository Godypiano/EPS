<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermitView.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.PermitView" %>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 90%; text-align:center">
                            <asp:LinkButton runat="server" ID="lnkPermit" CausesValidation="false" OnClick="lnkPermit_Click">Print to PDF</asp:LinkButton>
                        </td>
                        <td style="width: 5%;"></td>
                    </tr>
                    <tr>
