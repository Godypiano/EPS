<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupLoad.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.SetupLoad" %>
                    ...
                    <div
                        ...
                        <div class="row">
                            <div class="form-group row mx-0 mb-3 align-items-md-center">
                                ...
                                <asp:TextBox CssClass="form-control col-sm-12 col-md-9 col-lg-8 col-xl-7" runat="server" ID="txtVeh" MaxLength="100"></asp:TextBox>
                                <asp:RequiredFieldValidator runat="server" ID="rfvVeh" CssClass="red" ControlToValidate="txtVeh" Display="Dynamic" ErrorMessage="Please enter cargo Type"></asp:RequiredFieldValidator>
