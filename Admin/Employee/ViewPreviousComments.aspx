<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPreviousComments.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.ViewPreviousComments" %>
    ...
    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
        ...
        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
            ...
            <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-breadcrumbs">
                    <a href="Outbox.aspx" class="text-breadcrumbs text-hover-primary">Outbox</a>
                </li>
                    ...
                    <div class="card-body d-flex justify-content-between flex-column">
                        ...
                        <fieldset>
                            ...
                            <div id="applicant_details" class="row">
                                ...
                                <div class="form-group mx-0 mb-3 col-sm-6">
                                    <asp:Label CssClass="col-auto ps-0" runat="server" ID="Label6">Street
                                        Number
                                    </asp:Label>
                        ...
                        <fieldset runat="server" id="fsAttach" visible="false">
                            ...
                            <tr runat="server" id="trHire" visible="false">
                                <td>
                                    ...
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        <asp:Label CssClass="col-auto ps-0 sm_label-165px" runat="server" ID="lblEHire">Hiring Agreement
                                        </asp:Label>

                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                            <asp:LinkButton runat="server" ID="lnkHire" CausesValidation="false"
                            ...
                            <tr runat="server" id="trDraw" visible="false">
                                <td>
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        <asp:Label CssClass="col-auto ps-0 sm_label-165px" runat="server" ID="lblCID">Cargo Images &
                                            Drawings</asp:Label>

                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                            <asp:LinkButton runat="server" ID="lnkImages" CausesValidation="false"
                            ...
                            <tr runat="server" id="trWeight" visible="false">
                                <td>
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        <asp:Label CssClass="col-auto ps-0 sm_label-165px">Weigh Ticket
                                            from TANROADS</asp:Label>
                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                            <asp:LinkButton runat="server" ID="lnkTan" CausesValidation="false"
                            ...
                            <tr runat="server" id="trPolice" visible="false">
                                <td>
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        <asp:Label CssClass="col-auto ps-0 sm_label-165px">Confirmation
                                            Letter
                                            from Police</asp:Label>
                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                            <asp:LinkButton runat="server" ID="lnkPolice" CausesValidation="false"
                            ...
                            <tr runat="server" id="trTanesco" visible="false">
                                <td>
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        ...
                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                            <asp:LinkButton runat="server" ID="lnkTanesco" CausesValidation="false"
                            ...
                            <tr runat="server" id="trRoute" visible="false">
                                <td>
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        <label class="col-auto ps-0 sm_label-165px">
                                            Route Survey</label>
                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                            <asp:LinkButton runat="server" CausesValidation="false" ID="lnkRoute"
                            ...
                            <tr runat="server" id="trERoute" visible="false">
                                <td>
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        <label class="col-auto ps-0 sm_label-165px">Upload Route
                                            Survey</label>
                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                            ...
                            <tr runat="server" id="trAdvg" visible="false">
                                <td>
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        <asp:Label CssClass="col-auto ps-0 sm_label-165px">Advertisement
                                        </asp:Label>
                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                            ...
                            <tr runat="server" id="trMass" visible="false">
                                <td>
                                    <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-12">
                                        <asp:Label CssClass="col-auto ps-0 sm_label-165px" runat="server" ID="lblMD">Mass Document
                                        </asp:Label>
                                        <div class="form-group col-sm-12 col-md-12 col-xl-12 px-0">
                                            <asp:LinkButton runat="server" ID="lnkEMass" CausesValidation="false"
                        ...
                        <fieldset>
                            ...
                            <div class="table-responsive mb-4">
                                <asp:GridView ID="gvSurcharge"  CssClass="table table-row-bordered table__bordered table__bordered_td_radio table-row-gray-300 border-0 gy-2 mb-1"
                            runat="server" AutoGenerateColumns="false" Width="100%" AlternatingRowStyle-CssClass="AlternateItemStyle"
                            ...
                            <div class="table-responsive mb-1">
                                <asp:GridView ID="gvGVM" CssClass="table table-row-bordered table__bordered table__bordered_td_radio table-row-gray-300 border-0 gy-2 mb-1"
                            runat="server" AutoGenerateColumns="false" Width="100%" AlternatingRowStyle-CssClass="AlternateItemStyle"
                        ...
                        <tr runat="server" id="trsch" visible="false">
                            <td style="width: 100%;">
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="width: 100%;">
                                            Travel Schedule added by Transporter
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100%;">
                                            <asp:GridView ID="gvSch" Style="border-width: 0px; border-style: None; width: 100%; border-collapse: collapse;"
                                                runat="server" AutoGenerateColumns="false" Width="100%" AlternatingRowStyle-CssClass="AlternateItemStyle"
                                                HeaderStyle-CssClass="HeaderDatagrid" PageSize="10" OnPageIndexChanging="gvSch_PageIndexChanging" AllowPaging="true">
                                                <RowStyle HorizontalAlign="Left" CssClass="FirstItemStyle" />
                                                <PagerStyle CssClass="gridViewPager" />
                                                <Columns>
                                                    <asp:TemplateField HeaderText="SNo">
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkView" CausesValidation="false" Text='<%#Container.DataItemIndex+1 %>' OnClick="lnkView_Click"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                        ...
                        <tr runat="server" id="tremp" visible="false">
                            <td style="width: 100%;">
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="width: 100%;">
                                            Travel Schedule added by Employee
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100%; height: 20px;"></td>
                                    ...
                                    <tr>
                                        <td style="width: 100%;">
                                            <asp:GridView ID="gvSchemp" Style="border-width: 0px; border-style: None; width: 100%; border-collapse: collapse;"
                                                runat="server" AutoGenerateColumns="false" Width="100%" AlternatingRowStyle-CssClass="AlternateItemStyle"
                                                HeaderStyle-CssClass="HeaderDatagrid" PageSize="10" OnRowDataBound="SchempRowDataBound" OnPageIndexChanging="gvSchemp_PageIndexChanging" AllowPaging="true">
                                                <RowStyle HorizontalAlign="Left" CssClass="FirstItemStyle" />
                                                <PagerStyle CssClass="gridViewPager" />
                                                <Columns>
                                                    <asp:TemplateField HeaderText="SNo">
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkViewemp" CausesValidation="false" Text='<%#Container.DataItemIndex+1 %>' OnClick="lnkViewemp_Click"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ID" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblSNo" Text='<%#Eval("Permit_NO") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="Travel_Date" HeaderText="Travel Date" />
                                                    <asp:BoundField DataField="Travel_From" HeaderText="Travel From" />
