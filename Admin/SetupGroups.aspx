<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupGroups.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupGroups" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Axle Groups
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div class="row">
                                            <div class="form-group mx-0 mb-3 align-items-md-center">
                                                ...
                                                <asp:TextBox CssClass="form-control col-md-12 col-lg-10 col-xl-8"
                                                    runat="server" ID="txtDept" MaxLength="100"></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvDept" CssClass="red"
                                                    ControlToValidate="txtDept" Display="Dynamic"
                                                    ErrorMessage="Please enter groups name">
                                            ...
                                            <div class="form-group mx-0 mb-3 align-items-md-center">
                                                ...
                                                <asp:TextBox CssClass="form-control col-md-12 col-lg-10 col-xl-8"
                                                    runat="server" ID="txtDesc" TextMode="MultiLine" Rows="5"
                                                    Columns="30" MaxLength="200"></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1"
                                                    CssClass="red" ControlToValidate="txtDesc" Display="Dynamic"
                                        ...
                                        <div class="form-group mb-3 d-flex justify-content-end">
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                ID="btnSubmit" runat="server" Visible="false" Text="Create"
                                                OnClick="btnSubmit_Click" />
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                ID="btnUpdate" runat="server" Visible="false" Text="Update"
                                                OnClick="btnUpdate_Click" />
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                ID="btnDelete" runat="server" Visible="false" CausesValidation="false"
                                        ...
                                        <div id="table__responsive_Wrapper">
                                            <asp:GridView ID="gvDept"
                                                ...
                                                OnPageIndexChanging="gvDept_PageIndexChanging" PageSize="10"
                                                AllowPaging="false">
