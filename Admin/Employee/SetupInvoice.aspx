<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupInvoice.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.SetupInvoice" %>
    ...
    >
      ...
      >
        ...
        <ul class="breadcrumb fw-bold fs-base my-1">
          ...
          <li class="breadcrumb-item text-dark">Invoice Validity Period</li>
        </ul>
        <!--end::Breadcrumb-->
      </div>
      <!--end::Info-->
        ...
        <div class="col-xl-12">
          ...
          <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            >
              <div class="row">
                <div
                  class="form-group row mx-0 mb-3 align-items-sm-center"
                >
                  <label class="col-auto ps-0 label-100px"
                    >Valid Duration:</label
                  >

                  <div
                    class="input-group col-sm-8 col-md-6 col-lg-7 col-xl-5 px-0"
                  >
                    <asp:TextBox
              ...
              <div class="form-group mb-3 d-flex justify-content-end">
                ...
                <asp:Button
                  ...
                  OnClientClick="return confirm('Are you sure want to delete permit days?');"
                  Text="Delete"
