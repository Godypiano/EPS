<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupOverHang.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupOverHang" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Permited Overhang
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div class="row">
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-9 col-md-6 col-lg-5 col-xl-4">
                                                <label class="col-auto ps-0 label-80px">Right:</label>

                                                <div class="input-group col-sm-12 px-0">
                                                    <asp:TextBox CssClass="form-control" runat="server" ID="txtRight"
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="rfvDept" CssClass="red"
                                                    ControlToValidate="txtRight" Display="Dynamic"
                                                    ErrorMessage="Please enter right"></asp:RequiredFieldValidator>
                                            ...
                                            <div
                                                ...
                                                <div class="input-group col-sm-12 px-0">
                                                    <asp:TextBox CssClass="form-control" runat="server" ID="txtLeft"
                                                        MaxLength="100"></asp:TextBox>
                                                    <div class="input-group-append rounded-left-0">
                                                        <span class="input-group-text">M</span>
                                                    </div>
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1"
                                                    CssClass="red" ControlToValidate="txtLeft" Display="Dynamic"
                                                    ErrorMessage="Please enter left"></asp:RequiredFieldValidator>
                                            ...
                                            <div
                                                ...
                                                <div class="input-group col-sm-12 px-0">
                                                    <asp:TextBox CssClass="form-control" runat="server" ID="txtWall"
                                                        MaxLength="100"></asp:TextBox>
                                                    <div class="input-group-append rounded-left-0">
                                                        <span class="input-group-text">M</span>
                                                    </div>
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2"
                                                    CssClass="red" ControlToValidate="txtWall" Display="Dynamic"
                                                    ErrorMessage="Please enter wall"></asp:RequiredFieldValidator>
