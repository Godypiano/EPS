<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewApplication.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Permit.ViewApplication" %>
                    ...
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            ...
                            <h1 class="text-dark fw-bolder my-1 fs-2">
                                <asp:Label runat="server" CssClass="hd1" ID="lblVAP">View Application: </asp:Label>
                                <asp:Label runat="server" CssClass="hd1" ID="lblapp"></asp:Label>
                            </h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <fieldset>
                                            <h4>
                                                <asp:Label runat="server" ID="lblVC">Vehicle
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                    <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblLease">
                                                        Vehicle Lease Type <span class="red">*</span>
                                                    </asp:Label>
                                                    <asp:TextBox CssClass="form-control" runat="server" Enabled="false"
                                            ...
                                            <div id="applicant_details" class="row">
                                                ...
                                                <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                    <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblHZip"
                                                        Visible="false">Zip / Postal Code</asp:Label>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="form-group mx-0 mb-3 col-sm-4">
                                                    <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblADT">
                                                        Application Date and Time</asp:Label>
                                                    <asp:TextBox CssClass="form-control" runat="server" Enabled="false"
                                                        ID="lblADate"></asp:TextBox>
                                                </div>
                                                <div class="form-group mx-0 mb-3 col-sm-4">
                                                    <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblJD">
                                                        Journey Date</asp:Label>
                                                    <asp:TextBox CssClass="form-control" runat="server" Enabled="false"
                                                        ID="lblJDate"></asp:TextBox>
                                                </div>
                                                <div class="form-group mx-0 mb-3 col-sm-4">
                                                    <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblED">Permit
                                                        Expired Date</asp:Label>
                                                    <asp:TextBox CssClass="form-control" runat="server" Enabled="false"
                                                        ID="txtTo1"></asp:TextBox>
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            <h4 class="mt-3">
                                                <asp:Label runat="server" ID="lblTInfo">
                                                    Transport Information:</asp:Label>
                                            </h4>
                                                ...
                                                <table
                                                    ...
                                                    <thead
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <td>
                                                                <asp:Label runat="server" ID="lblULaden">Unladen Vehicle
                                                                    <span class="red">*</span>
                                                                </asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label runat="server" ID="lblLoad1">Load
                                                                    <span class="red">*</span>
                                                                </asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label runat="server" ID="lblLaden">Laden Vehicle
                                                                    <span class="red">*</span>
                                                                </asp:Label>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group col-sm-12 min-w-200px px-0">
                                                                    <asp:TextBox CssClass="form-control" ID="txtLength2"
                                                                        MaxLength="5" runat="server" Enabled="false">
                                                                    </asp:TextBox>
                                                            ...
                                                            <td>
                                                                <div class="input-group col-sm-12 min-w-200px px-0">
                                                                    <asp:TextBox CssClass="form-control" ID="lblLength"
                                                                        MaxLength="5" runat="server" Enabled="false">
                                                                    </asp:TextBox>
                                                                    <div class="input-group-append rounded-left-0">
                                                                        <span class="input-group-text">M</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group col-sm-12 min-w-200px px-0">
                                                                    <asp:TextBox CssClass="form-control" ID="txtHeight2"
                                                                        MaxLength="4" runat="server" Enabled="false">
                                                                    </asp:TextBox>
                                                                    <div class="input-group-append rounded-left-0">
                                                                        <span class="input-group-text">M</span>
                                                                    </div>
                                                            ...
                                                            <td>
                                                                <div class="input-group col-sm-12 min-w-200px px-0">
                                                                    <asp:TextBox CssClass="form-control" ID="lblHeight"
                                                                        MaxLength="4" runat="server" Enabled="false">
                                                                    </asp:TextBox>
                                                                    <div class="input-group-append rounded-left-0">
                                                                        <span class="input-group-text">M</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group col-sm-12 min-w-200px px-0">
                                                                    <asp:TextBox CssClass="form-control" ID="lblWidth"
                                                                        MaxLength="4" runat="server" Enabled="false">
                                                                    </asp:TextBox>
                                                                    <div class="input-group-append rounded-left-0">
                                                                        <span class="input-group-text">M</span>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label runat="server" ID="lblMass">Mass (Tonne)
                                                                </asp:Label>
                                                            </td>
                                                            <td>
                                                                <div class="input-group col-sm-12 min-w-200px px-0">
                                                ...
                                                <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                    ...
                                                    <div class="input-group col-sm-12 px-0">
                                                        <asp:TextBox CssClass="form-control" ID="txtORight"
                                                            MaxLength="5" runat="server" Enabled="false"></asp:TextBox>
                                                        <div class="input-group-append rounded-left-0">
                                                            <span class="input-group-text">M</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblACF">Axle
                                                    Configuration
                                                    <spanclass="red">*</spanclass=>
                                                </asp:Label>
                                                <asp:TextBox CssClass="form-control" runat="server" Enabled="false"
                                                    ID="lblAC"></asp:TextBox>
                                            </div>
                                        ...
                                        <fieldset id="fsReg">
                                            <h4 class="mt-3">
                                                <asp:Label runat="server" ID="lblVRD">Vehicle Registration Details:
                                                </asp:Label>
                                            </h4>
                                            <div class="row">
                                            ...
                                            <table id="table_input"
                                                ...
                                                <thead
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label runat="server" ID="lblASpace">Axle Spacing (M)
                                                            </asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label runat="server" ID="lblRAL">Required Axle Load
                                                                (Kg)
                                                                <span class="red"></span>
                                                            </asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label runat="server" ID="lblAAL">Actual Axle Load (Kg)
                                                            </asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label runat="server" ID="lblTW">Total Weight
                                                            </asp:Label><span class="red">*</span>
                                                        </td>
                                                        <td>
                                                            <div class="input-group col-sm-12 min-w-200px px-0">
                                                                <asp:TextBox CssClass="form-control min-w-150px" ID="lblWT"
                                                                    runat="server" Enabled="false"></asp:TextBox>
                                                                <div class="input-group-append rounded-left-0">
                                            ...
                                            <div id="load_info" class="row">
                                                ...
                                                <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                    <td id="tdin" visible="false" runat="server">
                                                        <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblUD">
                                                            Upload Document
                                                        </asp:Label>
                                                    </td>
                                                ...
                                                <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                    ...
                                                    <asp:TextBox CssClass="form-control" runat="server" ID="txtCD"
                                                        Width="40" Enabled="false" Visible="false" MaxLength="3"
                                                        Text="255">
                                                    </asp:TextBox>
                                                    ...
                                                    <td>
                                                        <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                            <asp:Label CssClass="col-auto ps-0" runat="server"
                                                                ID="lblNumP">Number of Police
                                                                <span class="red">*</span>
                                                            </asp:Label>
                                                            <asp:TextBox CssClass="form-control" runat="server"
                                                                ID="lblNOP" MaxLength="5" Enabled="false">
                                                            </asp:TextBox>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr runat="server" id="trnov" visible="false">
                                                    <td>
                                                        <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                            <asp:Label CssClass="col-auto ps-0" runat="server"
                                                                ID="lblNumV">Number of Vehicles
                                                                <span class="red">*</span>
                                                            </asp:Label>
                                                            <asp:TextBox CssClass="form-control" runat="server"
                                                                ID="lblNOV" MaxLength="5" Enabled="false"></asp:TextBox>
                                                        </div>
                                                    </td>
                                                </tr>
                                        ...
                                        <fieldset runat="server" id="fsFee" visible="false">
                                            <h4 class="mt-3">
                                                <asp:Label runat="server" ID="lblPS">Permit
                                                    Fee & Surcharge Details:</asp:Label>
                                            </h4>
                                            ...
                                            <div class="mb-1">
                                                <asp:Label runat="server" ID="lblPermit_Fee">Permit Fee
                                                </asp:Label> (
                                                <asp:Label runat="server" ID="lblPermit_Fee1">Permit Fee
                                                </asp:Label> +
                                                <asp:Label runat="server" ID="lblSurcharge_Fee">Surcharge Fee
                                                </asp:Label>:
                                                &nbsp;&nbsp;&nbsp;=>
                                                <asp:Label runat="server" ID="lblPermit_Fee2">Permit Fee
                                                </asp:Label>:
                                                <asp:Label runat="server" ID="lblPFee"> </asp:Label>
                                                &nbsp;&nbsp;&nbsp;=>
                                                <asp:Label runat="server" ID="lblSurcharge_Fee1">Surcharge Fee
                                                </asp:Label>: <asp:Label runat="server" ID="lblSF"> </asp:Label>
                                                )
                                            </div>

                                            <div>
                                                <b>
                                                    <asp:Label runat="server" ID="lblTotal_Permit_Fee">Total
                                                        Permit Fee</asp:Label>:
                                        ...
                                        <fieldset>
                                            <h4 class="mt-3">
                                                <asp:Label runat="server" ID="lblCmts">
                                                    Comments:</asp:Label>
                                            </h4>
                                                    ...
                                                    <asp:GridView ID="gvComments"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Commentd On"
                                                                ItemStyle-VerticalAlign="Top" ItemStyle-Width="60px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCD" runat="server">
                                                                    </asp:Label><br />
                                                                    <asp:Label ID="lblCBy" runat="server">
                                                                        Commented By
                                                                    </asp:Label>:<br />
                                                                    <asp:Label ID="lblCDate" runat="server">
                                                                        Commented Date
                                                                    </asp:Label>:<br />
                                                                    <asp:Label ID="lblCMT" runat="server">
                                                                        Comment
                                                                    </asp:Label>:<br />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Commented By"
                                                                ItemStyle-VerticalAlign="Top" ItemStyle-Width="200px">
                                                                <ItemTemplate>
    ...
    <script>
        (function () {
            $(function () {
                ...
                var attachments_ID = $('#attachments');

                hideEmptyFormGroups(applicant_details_ID);

                hide_d_none_span_FormGroup(applicant_details_ID);

                hideEmptyFormGroups(load_info_ID);

                add_Class_To_Table_Input(table_input);

                hideEmptyFormGroups(attachments_ID);
        ...
        function hide_d_none_span_FormGroup(rowID) {
            var details = $(rowID).find($(".form-group>span"));
