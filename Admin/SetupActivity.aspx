<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupActivity.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupActivity" %>
            ...
            <ContentTemplate>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 2%;"></td>
                        <td style="width: 96%;">
                            <a class="navigationbar" href="Dashboard.aspx">Home</a>&nbsp; &gt;&gt; &nbsp;<a class="navigationbar" href="SetupActivity.aspx">Activities</a>
                            </td>
                        <td style="width: 2%;"></td>
                    </tr>
                    <tr>
                ...
                <fieldset>
                    <legend>
                            <label class="hd1">Activities</label>
                             </legend>
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 2%;"></td>
                 ...
                 <table style="width: 100%;">
                     ...
                     <tr>
                        ...
                        <td style="width: 25%;">
                         ...
                         <td style="width: 25%;">
                            <label>Acticity Name</label>
                        </td>
                        <td style="width: 25%;">
                            <asp:TextBox runat="server" ID="txtaname" MaxLength="100" Width="150"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvname" CssClass="red" ControlToValidate="txtaname" Display="Dynamic" ErrorMessage="Please enter name"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 25%;">
                            ...
                            <asp:RequiredFieldValidator ID="rfvmodule" runat="server" ControlToValidate="ddlmodule" CssClass="red" Display="Dynamic" ErrorMessage="Please select module"></asp:RequiredFieldValidator>
                        </td>
                        <td style="width: 25%;">
                            <label>Status </label>
                        </td>
                        ...
                        <td colspan="2" style="width: 98%; text-align: center;">
                            <asp:GridView ID="gvDept" Style="border-width: 0px; border-style: None; width: 100%; border-collapse: collapse;"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MName" HeaderText="Module Name" />
