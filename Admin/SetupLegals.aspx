<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupLegals.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupLegals" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Legal Dimensions
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item text-dark">Legal Dimensions</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Info-->
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div class="row">
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-11 col-lg-9 col-xl-6">
                                                <label class="col-auto ps-0 label-115px">Type of Vehicle:</label>
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="rfvCargo" CssClass="red"
                                                    ...
                                                    ErrorMessage="Please select Configuration Type">
                                                </asp:RequiredFieldValidator>
                                            </div>

                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-11 col-lg-9 col-xl-6">
                                                <label class="col-auto ps-0 label-115px">Length:</label>

                                                <div class="input-group col-sm-12 px-0">
                                                    <asp:TextBox CssClass="form-control" ID="txtLength" MaxLength="5"
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator13"
                                                    CssClass="red" Display="Dynamic" ControlToValidate="txtLength"
                                                    ErrorMessage="Please enter Lenghth"></asp:RequiredFieldValidator>
                                            ...
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-11 col-lg-9 col-xl-6">
                                                <label class="col-auto ps-0 label-115px">Width:</label>

                                                <div class="input-group col-sm-12 px-0">
                                                    <asp:TextBox CssClass="form-control" ID="txtWidth" runat="server">
                                                    </asp:TextBox>
                                                    <div class="input-group-append rounded-left-0">
                                                        <span class="input-group-text">M</span>
                                                    </div>
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator15"
                                                    CssClass="red" Display="Dynamic" ControlToValidate="txtWidth"
                                            ...
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-11 col-lg-9 col-xl-6">
                                                <label class="col-auto ps-0 label-115px">Height:</label>

                                                <div class="input-group col-sm-12 px-0">
                                                    <asp:TextBox CssClass="form-control" ID="txtHeight" MaxLength="4"
                                                        runat="server"></asp:TextBox>
                                                    <div class="input-group-append rounded-left-0">
                                                        <span class="input-group-text">M</span>
                                                    </div>
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator17"
                                                    CssClass="red" Display="Dynamic" ControlToValidate="txtHeight"
