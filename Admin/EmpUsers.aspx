<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpUsers.aspx.cs"
MasterPageFile="~/Default_admin.Master"
Inherits="PresentationLayer.Admin.EmpUsers" %> <%@ MasterType
          ...
          <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
              ...
              <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-dark">View/Update Users</li>
              </ul>
              <!--end::Breadcrumb-->
            </div>
            <!--end::Info-->
                  ...
                  <div class="card-body d-flex justify-content-between flex-column">
                    ...
                    <div id="table__responsive_Wrapper">
                      <asp:GridView ID="gvUser"
                        ...
                        PageSize="10" OnPageIndexChanging="gvUser_PageIndexChanging" AllowPaging="false">
                        ...
                        <Columns>
                          ...
                          <asp:TemplateField HeaderText="ID" Visible="false">
                            <ItemTemplate>
                              <asp:Label runat="server" ID="lblID" Text='<%#Eval("Emp_Details_ID") %>'></asp:Label>
                            </ItemTemplate>
                          </asp:TemplateField>
