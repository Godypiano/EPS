<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupEscortV.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupEscortV" %>
                  ...
                  <div class="card-body d-flex justify-content-between flex-column">
                    <div class="row">
                      <div class="form-group row mx-0 mb-3 align-items-sm-center">
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="rfvVeh" CssClass="red" ControlToValidate="txtVeh"
                          Display="Dynamic" ErrorMessage="Please enter vehicle name"></asp:RequiredFieldValidator>
                    ...
                    <div class="form-group mb-3 d-flex justify-content-end">
                      ...
                      <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnDelete" runat="server"
                        ...
                        OnClientClick="return confirm('Are you sure want to delete escort vehicle?');" Text="Delete"
