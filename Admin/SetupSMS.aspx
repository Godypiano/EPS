<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupSMS.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupSMS" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">SMS Settings
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <asp:TextBox CssClass="form-control col-sm-12 col-lg-9 col-xl-12"
                                                    runat="server" ID="txtUname" MaxLength="100"></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvUname" CssClass="red"
                                                    ControlToValidate="txtUName" Display="Dynamic"
                                                    ErrorMessage="Please enter sms email"></asp:RequiredFieldValidator>
                                            ...
                                            <asp:GridView ID="gvDept"
                                              CssClass="table table-row-bordered table__bordered table__bordered_td_radio table-row-gray-300 border-0 gy-2 mb-1 display"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Mobile_Service"
                                                        HeaderText="Mobile Service ID" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                    </div>
