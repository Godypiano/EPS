<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupCargo.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupCargo" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Cargo
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item text-dark">Cargo</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Info-->
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div class="row">
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-8 col-lg-6">
                                                <label class="col-auto ps-0 label-100px">Cargo Name:</label>
                                                <asp:TextBox CssClass="form-control col-sm-12 col-lg-12" runat="server"
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="rfvVeh" CssClass="red"
                                                    ...
                                                    ErrorMessage="Please enter cargo name"></asp:RequiredFieldValidator>
                                            ...
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-8 col-lg-6">
                                                <label class="col-auto ps-0 label-100px">Cargo / Load:</label>
                                                <asp:DropDownList CssClass="form-control col-sm-12 col-lg-12"
                                                    runat="server" ID="ddlCargo">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvCargo" CssClass="red"
                                                    Visible="true" ControlToValidate="ddlCargo" Display="Dynamic"
                                                    ErrorMessage="Please select cargo"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div id="table__responsive_Wrapper">
                                            <asp:GridView ID="gvDept"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Cload" HeaderText="Cargo / Load" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                    </div>
