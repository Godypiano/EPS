<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditPermit.aspx.cs"
MasterPageFile="~/Default_admin.Master"
Inherits="PresentationLayer.Admin.AuditPermit" %> <%@ MasterType
          ...
          <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
              ...
              <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-dark">Permit Details</li>
              </ul>
              <!--end::Breadcrumb-->
            </div>
            <!--end::Info-->
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                  ...
                  <div class="card-body d-flex justify-content-between flex-column">
                    <div class="row">
                      <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-6 col-lg-6">
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="rfvFDate" ControlToValidate="txtFDate"
                          Display="Dynamic" CssClass="red" ErrorMessage="Please select from date">
                      ...
                      <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-6 col-lg-6">
                        ...
                        <div class="input-group col-md-12 col-lg-10 col-xl-9 px-0">
                          ...
                          <div class="input-group-append rounded-left-0">
                            <asp:ImageButton CssClass="input-group-text" runat="server" CausesValidation="false"
                              ID="iPopup1" ImageUrl="/images/calendar.png" />
                          </div>
                        </div>
                    ...
                    <div class="form-group mb-3 d-flex justify-content-end">
                      ...
                      <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnPdf" runat="server"
                        Text="Download PDF" OnClick="btnPdf_Click" />
                      <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap" ID="btnExcel" runat="server"
                    ...
                    <div id="table__responsive_Wrapper">
                      <asp:GridView ID="gvDept"
                        ...
                        <Columns>
                          <asp:BoundField DataField="AuditID" HeaderText="SNO" />
                          <asp:BoundField DataField="AuditAction" HeaderText="Action" />
                          <asp:BoundField DataField="Permit_Application_No" HeaderText="Application" />
                          <asp:BoundField DataField="Truck_Type" HeaderText="Vehicle" />
                          <asp:BoundField DataField="Axel_Configuration" HeaderText="Config" />
                          <asp:BoundField DataField="Total_Width" HeaderText="Width" />
                          <asp:BoundField DataField="Total_Height" HeaderText="Height" />
                          <asp:BoundField DataField="Total_Length" HeaderText="Length" />
                          <asp:BoundField DataField="Total_Weight" HeaderText="Weight" />
