<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogs.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.AdminLogs" %>
    ...
    <div>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div
                        ...
                        <div
                            ...
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Admin Logs
      <small class="text-muted fs-6 fw-normal ms-1"></small>
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item text-dark">Admin Logs</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Info-->
                                        ...
                                        <div class="row">
                                            <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-6 col-lg-6">
                                                ...
                                                <asp:CompareValidator ID="cmpFDate" runat="server" Display="Dynamic"
                                                    ErrorMessage="The date must be less than equal to today date" CssClass="red" ValueToCompare="<%# DateTime.Today.ToShortDateString() %>"
                                            ...
                                            <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-6 col-lg-6">
                                                ...
                                                <asp:CompareValidator ID="cmpVal" ControlToCompare="txtFDate" ControlToValidate="txtTDate" Display="Dynamic" CssClass="red"
