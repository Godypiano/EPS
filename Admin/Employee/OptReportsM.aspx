<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OptReportsM.aspx.cs" MasterPageFile="~/Default_custom.Master"
    Inherits="PresentationLayer.Admin.Employee.OptReportsM" %>
                ...
                <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                    ...
                    <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                        ...
                        <h1 class="text-dark fw-bolder my-1 fs-2">
                            ...
                            Operational Reports - Monthly Transaction
                            Report
                        </h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb fw-bold fs-base my-1">
                            ...
                            <li class="breadcrumb-item text-dark">Monthly
                                        ...
                                        <div class="table-responsive mb-1">
                                            <asp:GridView ID="GVDailyTransaction"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Application_No"
                                                    ...
                                                    <asp:BoundField DataField="Cargo_Type" HeaderText="Cargo<br/> Type"
                                                    ...
                                                    <asp:BoundField DataField="Truck_Number"
