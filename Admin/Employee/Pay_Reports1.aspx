<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pay_Reports1.aspx.cs" MasterPageFile="~/Default_custom.Master"
    Inherits="PresentationLayer.Admin.Employee.Pay_Reports1" %>
                ...
                <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                    ...
                    <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                        ...
                        <ul class="breadcrumb fw-bold fs-base my-1">
                            ...
                            <li class="breadcrumb-item text-dark">Daily Report</li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    <!--end::Info-->
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-body d-flex justify-content-between flex-column">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row mx-0 mb-3 align-items-sm-center col-lg-6">
                                            <asp:Label CssClass="col-auto ps-0 label-80px" ID="Ladateto" runat="server"
                                                Text="Date To">
                                            </asp:Label>
                                            <div class="col-sm-9 col-md-7 col-lg-12 col-xl-10 px-0">
                                                <div class="input-group">
                                                    <asp:TextBox ID="rpttxtDateTo" runat="server"
                                                        CssClass="form-control">
                                                    </asp:TextBox>
                                                    <div class="input-group-append rounded-left-0">
                                                        <asp:ImageButton class="input-group-text" ID="rptImgBtnDateTo"
                                                            runat="server" CausesValidation="false"
                                                            ImageUrl="/images/calendar.png" />
                                                        <ajaxToolkit:CalendarExtender ID="rptCalendarExtender2"
                                                            runat="server" Format="dd/MM/yyyy"
                                                            PopupButtonID="rptImgBtnDateTo"
                                                            TargetControlID="rpttxtDateTo" />
                                                    </div>
                                                </div>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                    ControlToValidate="rpttxtDateTo" ErrorMessage="Fill date to"
                                                    ForeColor="Red" Display="Dynamic">
                                                </asp:RequiredFieldValidator>
                                                <asp:CompareValidator ID="cmpVal" ControlToCompare="rpttxtDateFrom"
                                                    ControlToValidate="rpttxtDateTo" Display="Dynamic"
                                        ...
                                        <asp:GridView ID="GridPaymentReport"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Permit_Fee" DataFormatString="{0:N2}"
                                                    ItemStyle-HorizontalAlign="Right" HeaderText="Permit Fee (USD)"
    ...
    <script>
        $(function () {
            ...
            var runInvoiceBtn = $('.card-xl-stretch');

            var validationErrorMessages = $("span[data-val-display=Dynamic]");

            $(runInvoiceBtn).on('click', '.btn.btn-primary', function (e) {

                var hasNeedForPreLoader = false;

                $.each(validationErrorMessages, function (index, errorMessage) {

                    var cssDisplay = $(errorMessage).css('display');

                    if (cssDisplay === "none") {
                        hasNeedForPreLoader = true;
                    } else {
                        hasNeedForPreLoader = false;
                        return false;
                    }
                });

                if (hasNeedForPreLoader) {
