<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppStatus.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Permit.AppStatus" %>
                    ...
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            ...
                            <h1 class="text-dark fw-bolder my-1 fs-2">
                                <asp:Label runat="server" ID="lblAS">Applications Status</asp:Label>
                            </h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item text-dark">
                                    <asp:Label runat="server" ID="lblaps"></asp:Label>
                                </li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div id="table__responsive_Wrapper">
                                            <asp:GridView ID="gvPermit"
                                                ...
                                                OnRowDataBound="InbRowDataBound" PageSize="10" AllowPaging="true">
