<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateScreens.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.UpdateScreens" %>
    ...
    <div class="toolbar" id="kt_toolbar">
        <div
            ...
            <div
                ...
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Edit/Update Assign Screens
                ...
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-breadcrumbs">
                        <a
                            href="AssignScreens.aspx"
                            class="text-breadcrumbs text-hover-primary">Setup Assign Screens</a>
                    </li>
                    <li class="breadcrumb-item text-dark">Edit/Update Assign Screens</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Info-->
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div
                            ...
                            <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-6 col-lg-6">
                                ...
                                <asp:DropDownList CssClass="form-control col-md-12 col-lg-8" runat="server" ID="ddlDesig" AutoPostBack="true" OnSelectedIndexChanged="ddlDesig_SelectedIndexChanged">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvDesig" Display="Dynamic" ErrorMessage="Please select designation" ControlToValidate="ddlDesig"></asp:RequiredFieldValidator>
                            </div>
                            ...
                            <div class="mb-3">
                             ...
                             <div class="form-group col-12 mb-3 text-end">
                                <asp:Button
                                    CssClass="btn btn-primary btn-sm white-space-wrap" ID="btnSubmit" runat="server" Text="Update" OnClick="btnSubmit_Click" />
