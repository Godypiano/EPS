<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSText.aspx.cs"
MasterPageFile="~/Default_admin.Master"
Inherits="PresentationLayer.Admin.AuditSText" %> <%@ MasterType
                    ...
                    <div id="table__responsive_Wrapper">
                      <asp:GridView ID="gvDept"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="Flow_ID" HeaderText="Flow ID" />
                          <asp:BoundField DataField="E_Text" HeaderText="Text" />
