<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignUser.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.AssignUser" %>
            ...
            <div
              ...
              <div class="row">
                <div class="form-group row mx-0 mb-3 align-items-sm-center ">
                    ...
                    <asp:DropDownList CssClass="form-control col-sm-9 col-md-7 col-lg-8 col-xl-7" runat="server" ID="ddlFUser">
                        
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator runat="server" ID="rfvFUser" ControlToValidate="ddlFUser" CssClass="red" Display="Dynamic" ErrorMessage="Please select from user"></asp:RequiredFieldValidator>
                </div>
                
                <div class="form-group row mx-0 mb-3 align-items-sm-center ">
                    <label class="col-auto ps-0 label-80px">To User</label>
                    <asp:DropDownList CssClass="form-control col-sm-9 col-md-7 col-lg-8 col-xl-7" runat="server" ID="ddlTUser">
                        <asp:ListItem Value="">Select To User</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator runat="server" ID="rfvTUser" ControlToValidate="ddlTUser" Display="Dynamic" CssClass="red" ErrorMessage="Please select to user"></asp:RequiredFieldValidator>
                </div>
              
                <div class="form-group row mx-0 mb-3 align-items-sm-center ">
                    <label class="col-auto ps-0 label-80px">From Date</label>
                    
                    <div class="input-group col-sm-9 col-md-7 col-lg-8 col-xl-7 px-0">
