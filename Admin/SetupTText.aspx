<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupTText.aspx.cs" ValidateRequest="false" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupTText" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Terms of Use
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        <div class="form-group mb-3">
                                            ...
                                            <asp:TextBox CssClass="form-control col-lg-10 col-xl-9" runat="server"
                                                ID="txtDays" TextMode="MultiLine" Rows="5" Columns="30"></asp:TextBox>
                                            <asp:RequiredFieldValidator runat="server" ID="rfvDays" CssClass="red w-100"
                                                ControlToValidate="txtDays" Display="Dynamic"
                                                ErrorMessage="Please enter terms of use text">
                                        ...
                                        <div class="form-group mb-3 d-flex justify-content-end">
                                            ...
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                ...
                                                OnClientClick="return confirm('Are you sure want to delete email text?');"
