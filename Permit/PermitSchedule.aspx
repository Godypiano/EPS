<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermitSchedule.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Permit.PermitSchedule" %>
                                        ...
                                        <table style="width: 100%;">
                                            ...
                                            <div class="row">
                                                <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="rfvFDate"
                                                        CssClass="red" ControlToValidate="txtFDate" Display="Dynamic"
                                                ...
                                                <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="rfvFrom"
                                                        CssClass="red" ControlToValidate="txtFrom" Display="Dynamic"
                                                ...
                                                <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                    <label class="col-auto ps-0">Travel Time From (24 hours,
                                                        Ex: 12:30)</label>
                                                    <asp:TextBox CssClass="form-control" runat="server" ID="txtTFrom"
                                                        MaxLength="5">
                                                    </asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="rfvTFrom"
                                                        CssClass="red" ControlToValidate="txtTFrom" Display="Dynamic"
                                                ...
                                                <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                    <label class="col-auto ps-0">Travel Time To (24 hours,
                                                        Ex: 18:30)</label>
                                                    <asp:TextBox CssClass="form-control" runat="server" ID="txtTTo"
                                                        MaxLength="5">
                                                    </asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="rfvTTo"
                                                        CssClass="red" ControlToValidate="txtTTo" Display="Dynamic"
                                                ...
                                                <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="rfvDistance"
                                                        CssClass="red" ControlToValidate="txtDistance" Display="Dynamic"
                                                ...
                                                <div class="form-group row mx-0 mb-3 align-items-sm-center col-sm-6">
                                                    ...
                                                    <asp:TextBox CssClass="form-control" runat="server" ID="txtPlace"
                                                        MaxLength="100">
                                                    </asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="rfvPlace"
                                                        CssClass="red" ControlToValidate="txtPlace" Display="Dynamic"
                                            ...
                                            <div class="form-group mb-3 d-flex justify-content-end">
                                                <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                    ID="btnReg" runat="server" Text="Schedule" OnClick="btnReg_Click" />
