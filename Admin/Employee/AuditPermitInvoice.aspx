<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditPermitInvoice.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.AuditPermitInvoice" %>
          ...
          <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            >
              <div class="row">
                ...
                >
                  <label class="col-auto ps-0 label-80px"
                    >Date From</label
                  >

                  <div
                    class="input-group col-md-12 col-lg-10 col-xl-9 px-0"
                  >
                    <asp:TextBox
              ...
              <div class="table-responsive mb-1">
                ...
                >
                  ...
                  <Columns>
                    ...
                    />
                    <asp:BoundField
                      DataField="Permit_Application_No"
                      HeaderText="Application"
                    />
                    <asp:BoundField
                      DataField="Permit_Fee"
                      HeaderText="Permit Fee"
                    />
                    <asp:BoundField
                      DataField="Surcharge_Fee"
                      HeaderText="Surcharge Fee"
                    />
                    <asp:BoundField
                      DataField="Total_Fee"
