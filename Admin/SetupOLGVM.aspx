<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupOLGVM.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupOLGVM" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">Overload Fee for GVM
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div class="row">
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-xl-6">
                                                <label class="col-auto ps-0 label-215px">GVM Overloading Weight
                                                    From</label>
                                            ...
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-xl-6">
                                                <label class="col-auto ps-0 label-215px">GVM Overloading Weight Up
                                                    To</label>
                                            ...
                                            <div
                                                ...
                                                <div class="input-group col-sm-12 px-0">
                                                    <asp:TextBox CssClass="form-control" ID="txtOver" MaxLength="12"
                                                        runat="server"></asp:TextBox>
                                                    <div class="input-group-append rounded-left-0">
                                                ...
                                                <asp:RequiredFieldValidator runat="server" ID="rfvOver" CssClass="red"
                                                    Display="Dynamic" ControlToValidate="txtOver"
                                                    ErrorMessage="Please enter amount"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator runat="server" ID="revOver"
                                                    CssClass="red" ValidationExpression="^[0-9]{1,12}?(?:\.\d{1,2})?$"
                                                    ControlToValidate="txtOver" Display="Dynamic"
                                        ...
                                        <div class="form-group mb-3 d-flex justify-content-end">
                                            ...
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                ID="btnUpdate" runat="server" Visible="false" Text="Update" OnClick="btnUpdate_Click" />
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                ID="btnDelete" runat="server" CausesValidation="false" Visible="false"
                                                OnClientClick="return confirm('Are you sure want to delete overload gvm fee?');"
                                        ...
                                        <div id="table__responsive_Wrapper">
                                            <asp:GridView ID="gvDept"
                                                ...
                                                HeaderStyle-CssClass="HeaderDatagrid fw-bold fs-6 text-gray-800 border-bottom border-gray-200 table_header" PageSize="10"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Over_Gvm_Charg_Sno"
                                                        HeaderText="Department ID" ShowHeader="false">
                                                        <ItemStyle CssClass="hide" />
                                                        <HeaderStyle CssClass="hide" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Over_Weight_From"
                                                        HeaderText="GVM Overloading Weight From KG" />
                                                    <asp:BoundField DataField="Over_Weight_To"
                                                        HeaderText="GVM Overloading Weight To KG" />
                                                    <asp:BoundField DataField="Currency_Code"
                                                        HeaderText="Currency Code" />
                                                    <asp:BoundField DataField="Charge_Amount"
                                                        HeaderText="Overloading Fee Amount" />
