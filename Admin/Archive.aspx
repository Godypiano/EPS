<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Archive.aspx.cs"
    MasterPageFile="~/Default_admin.Master"
    Inherits="PresentationLayer.Admin.Archive" %>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder my-1 fs-2">View Archive Applications
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        <div class="row">
                                            <div
                                                ...
                                                <label class="col-auto ps-0 label-100px">
                                                    Date From</label>
                                                <div class="input-group col-md-12 col-lg-10 col-xl-10 px-0">
                                            ...
                                            <div
                                                ...
                                                <asp:TextBox CssClass="form-control col-sm-12 col-md-12 col-lg-10"
                                                    ID="txtApp" runat="server"></asp:TextBox>

                                            </div>
                                            <div
                                                class="form-group row mx-0 mb-3 align-items-md-center col-sm-6 col-lg-6">
                                                <label class="col-auto ps-0 label-100px">Status</label>
                                                <asp:DropDownList CssClass="form-control col-sm-12 col-md-12 col-lg-10"
                                                    runat="server" ID="ddlStatus">
                                                    <asp:ListItem Value="Select Status">Select Status</asp:ListItem>
                                                    <asp:ListItem Value="Approved for Payment">Approved for Payment
                                                    </asp:ListItem>
                                                    ...
                                                    <asp:ListItem Value="Waiting for Control No">Waiting for Control No
                                                    </asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div
                                        ...
                                        <div class="form-group col-12 mb-3 d-flex justify-content-end">
                                            ...
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap" ID="btnPdf"
                                                Visible="false" runat="server" Text="Download PDF"
                                                OnClick="btnPdf_Click" />
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap" ID="btnExcel"
                                                Visible="false" runat="server" Text="Download Excel"
                                        ...
                                        <div id="table__responsive_Wrapper">
                                            <asp:GridView ID="gvPermit"
                                                ...
                                                HeaderStyle-CssClass="HeaderDatagrid fw-bold fs-6 text-gray-800 border-bottom border-gray-200 table_header" PageSize="10" AllowPaging="true">
