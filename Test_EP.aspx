        ...
        <%
            try
            {
                ...
                if (lstPermits != null)
                {
                    ...
                    {
                        if (!alps.ValidateOLP(RFBpermits.Permit_Application_No))
                        {
                            ...
                            //{
                            alps.Permit_No = pdetails.Permit_No;
                            alps.Invoice_No = gInvoice.SNO;
                            alps.Permit_Date = pdetails.Permit_Fee_Date;
                            alps.Posted_Date = vp.Posted_Date;
                            alps.Trans_Name = cname;
                            alps.Trans_Phone = vp.Trailer_No;
                            alps.Trans_Email = details.Email_ID;
                            alps.Address1 = details.Pobox;
                            alps.Address2 = details.Address1;
                            alps.App_No = pID;
                            alps.Application_No = aNo;
                            alps.Total_Width = vp.Total_Width;
                            alps.Total_Height = vp.Total_Height;
                            alps.Total_Length = vp.Total_Length;
                            alps.Dimensions = vp.Total_Length + " X " + vp.Total_Width + " X " + vp.Total_Height;
                            alps.Total_Weight = vp.Total_Weight;
                            alps.Gross_Weight = getwno.GVM_Allowed_Weight;
                            alps.Cargo_Details = vp.Cargo_Details;
                            alps.Route_From = vp.Route_From;
                            alps.Route_To = vp.Route_To;
                            alps.Route_Via = vp.Route_Via;
                            alps.Valid_Days = (int)pdays;
                            alps.Org_Officer = fname.Full_Name;
                            if (fname1 != null)
                            {
                                alps.Auth_Officer = fname1.Full_Name;
                            }
                            else
                            {
                                alps.Auth_Officer = "Julius Chambo";
                            }
                            alps.Cargo = cargoname;
                            alps.AxleConfiguration = vp.Axel_Configuration;
                            alps.Truck_No = vreg;
                            alps.Overload_GVM_Fee = pdetails.Surcharge_Fee;
                            alps.Permit_Fee = pdetails.Permit_Fee;
                            alps.Final_Fee_USD = pdetails.Surcharge_Fee + pdetails.Permit_Fee;
                            alps.Final_Fee_TZS = paydetails_approve.Amount;
                            alps.Posted_By = fname.Emp_Details_ID.ToString();
                            alps.AddOverLoadPermit(alps);
