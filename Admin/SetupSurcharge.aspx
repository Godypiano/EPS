...
CodeBehind="SetupSurcharge.aspx.cs" MasterPageFile="~/Default_admin.Master"
Inherits="PresentationLayer.Admin.SetupSurcharge" %> <%@ MasterType
              ...
              <div class="col-xl-12">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                  ...
                  <div class="card-body d-flex justify-content-between flex-column">
                    <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-12 col-md-9 col-lg-7">
                      <label class="col-auto ps-0 label-105px">Penalty Factor:</label>
                      <div class="input-group col-sm-12 px-0">
                        <asp:TextBox CssClass="form-control" runat="server" ID="txtDays" MaxLength="100"></asp:TextBox>
                      ...
                      <asp:RequiredFieldValidator runat="server" ID="rfvDays" CssClass="red" ControlToValidate="txtDays"
                        Display="Dynamic" ErrorMessage="Please enter surcharge"></asp:RequiredFieldValidator>
                    ...
                    <div class="form-group mb-3 d-flex justify-content-end">
                      ...
                      <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1" ID="btnDelete" runat="server"
                        ...
                        OnClientClick="return confirm('Are you sure want to delete surcharge?');" Text="Delete"
                    ...
                    <div id="table__responsive_Wrapper">
                      <asp:GridView ID="gvDept"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="S_Surcharge" HeaderText="Surcharge" />
