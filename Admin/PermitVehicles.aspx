<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermitVehicles.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.PermitVehicles" %>
 ...
 <div class="toolbar" id="kt_toolbar">
    <div
        ...
        <div
            ...
            <!--begin::Title-->
            <h1 class="text-dark fw-bolder my-1 fs-2">List of Permit Vehicles
                        ...
                        <div class="table-responsive mb-1">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="SNo">
                                    <ItemTemplate>
                                        <asp:LinkButton runat="server" ID="lnkView" Text='<%#Eval("Vehicle_SNO") %>' OnClick="lnkView_Click"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Vehicle_Name" HeaderText="Vehicle Name" />
                                <asp:BoundField DataField="NO_Registrations" HeaderText="No of Registrations" />
                            </Columns>
                        </asp:GridView>
