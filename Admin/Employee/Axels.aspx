<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Axels.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.Axels" %>
    ...
    <div
        ...
        <div
            ...
            <h1 class="text-dark fw-bolder my-1 fs-2">
                ...
                <small class="text-dark fs-2 fw-normal ms-1">List of Axles</small>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
