<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupQuery.aspx.cs" MasterPageFile="~/Default_admin.Master" Inherits="PresentationLayer.Admin.SetupQuery" %>
...
<div class="toolbar" id="kt_toolbar">
    <div
        ...
        <div
            ...
            <!--begin::Title-->
            <h1 class="text-dark fw-bolder my-1 fs-2">Dynamic Reports
                        ...
                        <div class="row">
                            <div class="form-group row mx-0 mb-3 align-items-md-center col-sm-6">
                                ...
                                <asp:comparevalidator ID="cmpFDate" runat="server" Display="Dynamic" 
                                  errormessage="The date must be less than or equal to today date" CssClass="red"  valuetocompare="<%# DateTime.Today.ToShortDateString() %>"
