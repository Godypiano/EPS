<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupLoadC.aspx.cs" MasterPageFile="~/Default_admin.Master"
    Inherits="PresentationLayer.Admin.SetupLoadC" %>
    ...
    <%@ MasterType VirtualPath="~/Default_admin.master" %>
        ...
        <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
            ...
            <style>
                #table__responsive_Wrapper table td input[type=radio] {
                    pointer-events: none;
                }

                #table__responsive_Wrapper table tr {
                    cursor: pointer;
                }
            </style>
        </asp:Content>
                        ...
                        <div class="toolbar" id="kt_toolbar">
                            <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                                ...
                                <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                    <!--begin::Title-->
                                    <h1 class="text-dark fw-bolder my-1 fs-2">Load Categories
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-lg-6 col-xl-5">
                                                        <div class="col-sm-12 px-0">
                                                            <div class="row">
                                                                <div class="form-group mx-0 mb-3 col-sm-12">
                                                                    <label class="col-auto ps-0">Load
                                                                        Cagtegory</label>
                                                                    <asp:TextBox CssClass="form-control col-sm-12"
                                                                        runat="server" ID="txtVeh" MaxLength="100">
                                                                    </asp:TextBox>
                                                                    <asp:RequiredFieldValidator runat="server"
                                                                        ID="rfvVeh" CssClass="red"
                                                                        ControlToValidate="txtVeh" Display="Dynamic"
                                                                        ErrorMessage="Please enter load category">
                                                     ...
                                                     ErrorMessage="Accepts characters, numbers, hypens, and(&),apostrophe('), and spaces only" CssClass="red">
                                                        ...
                                                        <div
                                                            class="col-sm-12 px-0 form-group mb-3 d-flex justify-content-end">
                                                            <asp:Button
                                                        ...
                                                        <div id="table__responsive">
                                                            <asp:GridView ID="gvDept"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="LoadC_Name"
                                                                        HeaderText="Category " />
