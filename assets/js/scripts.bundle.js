...
var KTDialer = function (e, t) {
    ...
    if (e) {
        var i = {
            ...
            r = function () {
                n.options = KTUtil.deepExtend({}, i, t), n.element = e, n.incElement = n.element.querySelector('[data-kt-dialer-control="increase"]'), n.decElement = n.element.querySelector('[data-kt-dialer-control="decrease"]'), n.inputElement = n.element.querySelector("input[type]"), d("decimals") && (n.options.decimals = parseInt(d("decimals"))), d("prefix") && (n.options.prefix = d("prefix")), d("suffix") && (n.options.suffix = d("suffix")), d("step") && (n.options.step = parseFloat(d("step"))), d("min") && (n.options.min = parseFloat(d("min"))), d("max") && (n.options.max = parseFloat(d("max"))), n.value = parseFloat(n.inputElement.value.replace(/[^\d.]/g, "")), u(), o(), KTUtil.data(n.element).set("dialer", n)
            },
            o = function () {
            ...
            a = function () {
                return KTEventHandler.trigger(n.element, "kt.dialer.increase", n), n.inputElement.value = n.value + n.options.step, u(), KTEventHandler.trigger(n.element, "kt.dialer.increased", n), n
            },
            l = function () {
                return KTEventHandler.trigger(n.element, "kt.dialer.decrease", n), n.inputElement.value = n.value - n.options.step, u(), KTEventHandler.trigger(n.element, "kt.dialer.decreased", n), n
            },
            u = function () {
                KTEventHandler.trigger(n.element, "kt.dialer.change", n), n.value = parseFloat(n.inputElement.value.replace(/[^\d.]/g, "")), n.value < n.options.min && (n.value = n.options.min), n.value > n.options.max && (n.value = n.options.max), n.inputElement.value = s(n.value), KTEventHandler.trigger(n.element, "kt.dialer.changed", n)
            },
            s = function (e) {
...
var KTDrawer = function (e, t) {
    ...
    if (null != e) {
        var r = {
            ...
            l = function () {
                !1 !== KTEventHandler.trigger(n.element, "kt.drawer.toggle", n) && (!0 === n.shown ? u() : s(), KTEventHandler.trigger(n.element, "kt.drawer.toggled", n))
            },
            u = function () {
...
var KTFeedback = function (e) {
    ...
    r(), t.show = function () {
        ...
        return function () {
            if (!1 !== KTEventHandler.trigger(t.element, "kt.feedback.hide", t)) return "popup" === t.options.type && u(), t.shown = !1, KTEventHandler.trigger(t.element, "kt.feedback.hidden", t), t
        }()
    }, t.isShown = function () {
        return t.shown
...
var KTImageInput = function (e, t) {
    ...
    if (null != e) {
        var i = {},
            ...
            o = function () {
                KTUtil.addEvent(n.inputElement, "change", a), KTUtil.addEvent(n.cancelElement, "click", l), KTUtil.addEvent(n.removeElement, "click", u)
            },
            a = function (e) {
...
var KTMenu = function (e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            r = function () {
                n.options = KTUtil.deepExtend({}, i, t), n.uid = KTUtil.getUniqueId("menu"), n.element = e, n.triggerElement, d(), s(), KTUtil.data(n.element).set("menu", n)
            },
            o = function (e) {
                null !== e && (!0 === m(e) ? l(e) : a(e))
            },
            a = function (e) {
                null !== e && !0 !== m(e) && ("dropdown" === T(e) ? E(e) : "accordion" === T(e) && S(e), KTUtil.data(e).set("type", T(e)))
            },
            l = function (e) {
                null !== e && !1 !== m(e) && ("dropdown" === T(e) ? w(e) : "accordion" === T(e) && A(e))
            },
            u = function (e) {
                if (!1 !== f(e)) {
                    var t = p(e);
                    KTUtil.data(e).has("type") && KTUtil.data(e).get("type") !== T(e) && (KTUtil.removeClass(e, "hover"), KTUtil.removeClass(e, "show"), KTUtil.removeClass(t, "show"))
                }
            },
            s = function () {
            ...
            m = function (e) {
                var t = p(e);
                return null !== t && ("dropdown" === T(e) ? !0 === KTUtil.hasClass(t, "show") && !0 === t.hasAttribute("data-popper-placement") : KTUtil.hasClass(e, "show"))
            },
            f = function (e) {
            ...
            w = function (e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.hide", e)) {
                    var t = p(e);
                    KTUtil.css(t, "z-index", ""), KTUtil.css(t, "width", ""), KTUtil.css(t, "height", ""), KTUtil.removeClass(e, "show"), KTUtil.removeClass(e, "menu-dropdown"), KTUtil.removeClass(t, "show"), !0 === x(e, "overflow") && (e.classList.contains("menu-item") ? e.appendChild(t) : KTUtil.insertAfter(n.element, e), KTUtil.data(e).remove("sub"), KTUtil.data(t).remove("item"), KTUtil.data(t).remove("menu")), y(e), KTEventHandler.trigger(n.element, "kt.menu.dropdown.hidden", e)
                }
            },
            b = function (e, t) {
                var n, i = x(e, "attach");
            ...
            I = function (e) {
                ...
                if (i && i.length > 0)
                    for (var r = 0, o = i.length; r < o; r++) t = i[r], "accordion" === T(t) && t !== e && !1 === e.contains(t) && !1 === t.contains(e) && A(t)
            },
            x = function (e, t) {
                var n, i = null;
        ...
        !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : r(), n.click = function (e, t) {
            ...
            return function (e, t) {
                ...
                if (null !== n && "dropdown" === T(n) && (l(n), i.length > 0))
                    for (var r = 0, o = i.length; r < o; r++) null !== i[r] && "dropdown" === T(i[r]) && l(tems[r])
            }(e)
    ...
    if (e) {
        var i = {
            ...
            a = function () {
                var e = 0,
                    t = m();
                !0 === l() && (e += t), !0 === n.options.checkUppercase && !0 === u() && (e += t), !0 === n.options.checkLowercase && !0 === s() && (e += t), !0 === n.options.checkDigit && !0 === d() && (e += t), !0 === n.options.checkChar && !0 === c() && (e += t), n.score = e, f()
            },
            l = function () {
...
var KTScroll = function (e, t) {
    ...
    if (e) {
        var i = {
            ...
            a = function () {
                var e, t;
                !0 === s("activate") || !1 === n.element.hasAttribute("data-kt-scroll-activate") ? (e = d(), null !== (t = l()) && t.length > 0 ? KTUtil.css(n.element, e, t) : KTUtil.css(n.element, e, ""), !0 === s("save-state") && void 0 !== KTCookie && n.id ? n.element.addEventListener("scroll", o) : n.element.removeEventListener("scroll", o), function () {
                    if (!0 === s("save-state") && void 0 !== KTCookie && n.id && KTCookie.get(n.id + "st")) {
            ...
            u = function () {
                ...
                if (null !== i && ((e = document.querySelectorAll(i)) && e.length > 0))
                    for (var a = 0, l = e.length; a < l; a++) {
                        var u = e[a];
                        !1 !== KTUtil.visible(u) && (t -= parseInt(KTUtil.css(u, "height")), t -= parseInt(KTUtil.css(u, "margin-top")), t -= parseInt(KTUtil.css(u, "margin-bottom")), KTUtil.css(u, "border-top") && (t -= parseInt(KTUtil.css(u, "border-top"))), KTUtil.css(u, "border-bottom") && (t -= parseInt(KTUtil.css(u, "border-bottom"))))
                    }
                if (null !== r && ((e = document.querySelectorAll(r)) && e.length > 0))
                    for (a = 0, l = e.length; a < l; a++) {
                        u = e[a];
                        !1 !== KTUtil.visible(u) && (t -= parseInt(KTUtil.css(u, "margin-top")), t -= parseInt(KTUtil.css(u, "margin-bottom")), t -= parseInt(KTUtil.css(u, "padding-top")), t -= parseInt(KTUtil.css(u, "padding-bottom")), KTUtil.css(u, "border-top") && (t -= parseInt(KTUtil.css(u, "border-top"))), KTUtil.css(u, "border-bottom") && (t -= parseInt(KTUtil.css(u, "border-bottom"))))
                    }
                return null !== o && (t -= parseInt(o)), t -= parseInt(KTUtil.css(n.element, "margin-top")), t -= parseInt(KTUtil.css(n.element, "margin-bottom")), KTUtil.css(u, "border-top") && (t -= parseInt(KTUtil.css(u, "border-top"))), KTUtil.css(u, "border-bottom") && (t -= parseInt(KTUtil.css(u, "border-bottom"))), t = String(t) + "px"
            },
            s = function (e) {
            ...
            d = function () {
                return s("height") ? "height" : s("min-height") ? "min-height" : s("max-height") ? "max-height" : void 0
            };
...
var KTSearch = function (e, t) {
    ...
    if (e) {
        var i = {
            ...
            r = function () {
                n.options = KTUtil.deepExtend({}, i, t), n.processing = !1, n.element = e, n.contentElement = T("content"), n.formElement = T("form"), n.inputElement = T("input"), n.spinnerElement = T("spinner"), n.clearElement = T("clear"), n.toggleElement = T("toggle"), n.submitElement = T("submit"), n.toolbarElement = T("toolbar"), n.resultsElement = T("results"), n.suggestionElement = T("suggestion"), n.emptyElement = T("empty"), n.layout = p("layout"), "menu" === n.layout ? n.menuObject = new KTMenu(n.contentElement) : n.menuObject = null, m(), o(), KTUtil.data(n.element).set("search", n)
            },
            o = function () {
                /* @author: Shilloh
                 * @date: 2021.06.23
                 * @description: I am not sure if this works. I added the if (n.inputElement) {} to enclose the error which was raised
                 */
                if (n.inputElement) {
                    n.inputElement.addEventListener("focus", a), n.inputElement.addEventListener("blur", l), !0 === p("keypress") && n.inputElement.addEventListener("input", s), n.submitElement && n.submitElement.addEventListener("click", d), !0 === p("enter") && n.inputElement.addEventListener("keypress", u), n.clearElement && n.clearElement.addEventListener("click", c), n.menuObject && (n.toggleElement && (n.toggleElement.addEventListener("click", f), n.menuObject.on("kt.menu.dropdown.show", (function (e) {
...
var KTStepper = function (e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            a = function () {
                var e = "";
                e = l() ? "last" : u() ? "first" : "between", KTUtil.removeClass(n.element, "last"), KTUtil.removeClass(n.element, "first"), KTUtil.removeClass(n.element, "between"), KTUtil.addClass(n.element, e);
                    ...
                    for (var i = 0, r = t.length; i < r; i++) {
                        ...
                        if (KTUtil.removeClass(o, "current"), KTUtil.removeClass(o, "completed"), KTUtil.removeClass(o, "pending"), a == n.currentStepIndex) {
                            if (KTUtil.addClass(o, "current"), !1 !== n.options.animation && "content" == o.getAttribute("data-kt-stepper-element")) {
                                ...
                                var s = "previous" === f(n.passedStepIndex) ? n.options.animationPreviousClass : n.options.animationNextClass;
    ...
    if (null != e) {
        var r = {
            ...
            a = function (e) {
                var t, r = s("offset"),
                    o = s("reverse");
                !1 !== r && (r = parseInt(r), t = KTUtil.getScrollTop(), !0 === o ? (t > r && n.lastScrollTop < t ? (!1 === i.hasAttribute(n.attributeName) && (l(), i.setAttribute(n.attributeName, "on")), !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (u(), i.removeAttribute(n.attributeName)), !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), n.eventTriggerState = !0)), n.lastScrollTop = t) : t > r ? (!1 === i.hasAttribute(n.attributeName) && (l(), i.setAttribute(n.attributeName, "on")), !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (u(), i.removeAttribute(n.attributeName)), !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), n.eventTriggerState = !0)))
            },
            l = function (e) {
                var t = s("top"),
                    i = s("left"),
                    r = (s("right"), s("width")),
                    o = s("zindex");
                if (!0 !== e && !0 === s("animation") && (KTUtil.css(n.element, "animationDuration", s("animationSpeed")), KTUtil.animateClass(n.element, "animation " + s("animationClass"))), null !== o && (KTUtil.css(n.element, "z-index", o), KTUtil.css(n.element, "position", "fixed")), null !== t && KTUtil.css(n.element, "top", t), null !== r) {
                    if (r.target) {
        ...
        !0 === KTUtil.data(e).has("sticky") ? n = KTUtil.data(e).get("sticky") : o(), n.update = function () {
            !0 === i.hasAttribute(n.attributeName) && (u(), i.removeAttribute(n.attributeName), l(!0), i.setAttribute(n.attributeName, "on"))
        }, n.on = function (e, t) {
            return KTEventHandler.on(n.element, e, t)
        }, n.one = function (e, t) {
            return KTEventHandler.one(n.element, e, t)
...
var KTToggle = function (e, t) {
    ...
    if (e) {
        var i = {
            ...
            a = function () {
                return KTEventHandler.trigger(n.element, "kt.toggle.change", n), s() ? u() : l(), KTEventHandler.trigger(n.element, "kt.toggle.changed", n), n
            },
            l = function () {
                if (!0 !== s()) return KTEventHandler.trigger(n.element, "kt.toggle.enable", n), n.target.setAttribute(n.attribute, "on"), n.state.length > 0 && n.element.classList.add(n.state), void 0 !== KTCookie && !0 === n.options.saveState && KTCookie.set(n.attribute, "on"), KTEventHandler.trigger(n.element, "kt.toggle.enabled", n), n
            },
            u = function () {
                if (!1 !== s()) return KTEventHandler.trigger(n.element, "kt.toggle.disable", n), n.target.removeAttribute(n.attribute), n.state.length > 0 && n.element.classList.remove(n.state), void 0 !== KTCookie && !0 === n.options.saveState && KTCookie.remove(n.attribute), KTEventHandler.trigger(n.element, "kt.toggle.disabled", n), n
            },
            s = function () {
        ...
        animate: function (e, t, n, i, r, o) {
            ...
            if (a.linear = function (e, t, n, i) {
                ...
                var l = window.requestAnimationFrame || function (e) {
                    ...
                    u = t - e;
                i(e);
                var s = window.performance && window.performance.now ? window.performance.now() : +new Date;
                l((function a(d) {
                    var c = (d || +new Date) - s;
...
var KTApp = function () {
    ...
    return {
        init: function () {
            this.initPageLoader(), this.initBootstrapTooltips(), this.initBootstrapPopovers(), this.initScrollSpy(), this.initButtons(), this.initCheck(), this.initSelect2(), this.initCountUp(), this.initCountUpTabs(), this.initAutosize(), this.initTinySliders()
        },
        ...
        initBootstrapTooltips: function () {
            var e, t;
            e = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')), t = {}, e.map((function (e) {
                return e.hasAttribute("data-bs-delay-hide") && (t.delay = {
                    hide: e.getAttribute("data-bs-delay-hide")
                }), new bootstrap.Tooltip(e, t)
            }))
        },
        initBootstrapPopovers: function () {
            var e, t;
            e = [].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]')), t = {}, e.map((function (e) {
                return e.hasAttribute("data-bs-delay-hide") && (t.delay = {
                    hide: e.getAttribute("data-bs-delay-hide")
...
var KTLayoutHeader = function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_header")) && KTSticky.getInstance(e).on("kt.sticky.change", (function () {
                setTimeout((function () {
...
var KTLayoutSearch = function () {
    var e, t, n, i, r, o, a, l, u, s = function (e) {
            setTimeout((function () {
