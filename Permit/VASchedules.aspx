<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VASchedules.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Permit.VASchedules" %>
                    ...
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            ...
                            <h1 class="text-dark fw-bolder my-1 fs-2">
                                <asp:Label runat="server" ID="lblTS">Travel Schedule</asp:Label>
                            </h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <div class="text-end mb-3">
                                            <asp:LinkButton runat="server" CssClass="navigationbar"
                                                CausesValidation="false" Visible="true" ID="lnkEnglish"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblANo">Application No</asp:Label>
                                                <asp:TextBox CssClass="form-control" ID="txtApp" runat="server" Enabled="false">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvApp" Display="Dynamic"
                                                    ControlToValidate="txtApp"
                                                    ErrorMessage="Application number should not blank">
                                                </asp:RequiredFieldValidator>
                                            </div>

                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblTDate">Travel Date</asp:Label>
                                                ...
                                                <div class="input-group col-sm-12 px-0">
                                                    ...
                                                    <div class="input-group-append rounded-left-0">
                                                      <asp:ImageButton CssClass="input-group-text" runat="server" CausesValidation="false"
                                                        ID="iPopup" ImageUrl="/images/calendar.png" />
                                                    </div>
                                                  </div>
                                            ...
                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblTFrom">Travel From</asp:Label>
                                            ...
                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblTTo">Travel To</asp:Label>
                                                <asp:TextBox CssClass="form-control" runat="server" ID="txtTo" MaxLength="100">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvTo"
                                                    ControlToValidate="txtTo" Display="Dynamic"
                                                    ErrorMessage="Please enter to name">
                                                </asp:RequiredFieldValidator>
                                            </div>

                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblTTFrom">Travel Time
                                                    From (24 hours, Ex: 12:30)</asp:Label>
                                                <asp:TextBox CssClass="form-control" runat="server" ID="txtTFrom" MaxLength="5">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvTFrom"
                                                    ControlToValidate="txtTFrom" Display="Dynamic"
                                                    ErrorMessage="Please enter from travel time">
                                                </asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator runat="server" ID="revTFrom"
                                                    Display="Dynamic"
                                            ...
                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblTTTo">Travel Time To (24 hours, Ex: 18:30)
                                                </asp:Label>
                                                <asp:TextBox CssClass="form-control" runat="server" ID="txtTTo" MaxLength="5">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvTTo"
                                                    ControlToValidate="txtTTo" Display="Dynamic"
                                                    ErrorMessage="Please enter to travel time">
                                                </asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator runat="server" ID="revTTo"
                                                    Display="Dynamic"
                                                    ValidationExpression="^([0-1]?[0-9]|[2][0-3]):([0-5][0-9])$"
                                            ...
                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblDistance">Distance KM
                                                </asp:Label>
                                                <asp:TextBox CssClass="form-control" runat="server" ID="txtDistance" MaxLength="5">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvDistance"
                                            ...
                                            <div class="form-group mx-0 mb-3 col-sm-6 col-md-6">
                                                <asp:Label CssClass="col-auto ps-0" runat="server" ID="lblParking">Parking Place
                                                </asp:Label>
                                                <asp:TextBox CssClass="form-control" runat="server" ID="txtPlace" MaxLength="100">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvPlace"
                                                    ControlToValidate="txtPlace" Display="Dynamic"
                                                    ErrorMessage="Please enter Parking Place">
                                                </asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 d-flex justify-content-end">
                                            ...
                                            <asp:Button CssClass="btn btn-primary btn-sm white-space-wrap me-1"
                                                ...
                                                OnClientClick="return confirm('Are you sure want to delete schedule?');"
                                        ...
                                        <div class="table-responsive mb-1">
                                            <asp:GridView ID="gvDept"
                                                ...
                                                OnRowDataBound="SchRowDataBound"
