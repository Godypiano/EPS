<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeBehind="AnualReports.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Admin.Reports.AnualReports" %>
                        ...
                        <td colspan="2" style="width: 90%;">
                            <asp:GridView ID="gvDaily" Style="border-width: 0px; border-style: None; width: 100%; border-collapse: collapse;"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="No. of Permits Issued">
                                        <ItemTemplate>
