<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPermit.aspx.cs" MasterPageFile="~/Default.Master" Inherits="PresentationLayer.Permit.ViewPermit" %>
                    ...
                    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                            ...
                            <h1 class="text-dark fw-bolder my-1 fs-2">
                                <asp:Label runat="server" ID="lblVAP">View Application: </asp:Label>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column">
                                        ...
                                        <fieldset>
                                            <h4 class="mt-3">
                                                <asp:Label runat="server" ID="lblTInfo">Transport Information:
                                                </asp:Label>
                                            </h4>
                                                ...
                                                <table id="table_input"
                                                    ...
                                                    <thead
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <asp:Label runat="server" ID="lblASpace">Axle Spacing
                                                                    (M)
                                                                </asp:Label><br />
                                                            </th>
                                                            <th>
                                                                <asp:Label runat="server" ID="lblRAL">Required Axle Load
                                                                    (Kg)</asp:Label><span class="red"></span><br />
                                                            </th>
                                                            <th>
                                                                <asp:Label runat="server" ID="lblAAL">Actual Axle Load
                                                                    (Kg)</asp:Label>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                            ...
                                            <div id="load_info" class="row">
                                                ...
                                                <tr>
                                                    <td id="tdin" visible="false" runat="server">
                                                        <asp:Label runat="server" ID="lblUD">Upload Document
                                                        </asp:Label>
                                                    </td>
                                        ...
                                        <fieldset runat="server" id="fsFee" visible="false">
                                            ...
                                            <div>
                                                ...
                                                </asp:Label> ( <asp:Label runat="server" ID="lblPermit_Fee1">
                                                    Permit Fee
                                                </asp:Label> + <asp:Label runat="server" ID="lblSurcharge_Fee">
                                                    Surcharge
                                                    Fee</asp:Label>:
                                                &nbsp;&nbsp;&nbsp;=> <asp:Label runat="server" ID="lblPermit_Fee2">
                                                    Permit Fee
                                                </asp:Label>: <asp:Label runat="server" ID="lblPFee">
                                                </asp:Label>
                                                &nbsp;&nbsp;&nbsp;=> <asp:Label runat="server" ID="lblSurcharge_Fee1">
                                                    Surcharge
                                                    Fee</asp:Label>: <asp:Label runat="server" ID="lblSF">
                                                </asp:Label>
                                            </div>
