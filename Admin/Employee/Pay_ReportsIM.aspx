<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pay_ReportsIM.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.Pay_ReportsIM" %>
                                ...
                                <div class="card-body d-flex justify-content-between flex-column">
                                            ...
                                            <div class="col-sm-9 col-md-7 col-lg-12 col-xl-10 px-0">
                                                <div class="input-group">
                                                    ...
                                                    <ajaxToolkit:CalendarExtender ID="invoiceCalendarExtender1"
                                                        ...
                                                        TargetControlID="invoicetxtDateFrom" OnClientHidden="onCalendarHidden"
                                    ...
                                    <div id="table__responsive_Wrapper1" class="mb-6 table-responsive">
                                        <asp:GridView ID="GridViewInvoice"
                                            ...
                                            runat="server" AllowPaging="False" Width="100%"
