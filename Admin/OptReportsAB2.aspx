<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OptReportsAB2.aspx.cs" MasterPageFile="~/Default_admin.Master"
    Inherits="PresentationLayer.Admin.OptReportsAB2" %>
        ...
        $("#btnSubmit").click(function () {
            ...
            else
            {
                ...
                $.ajax({
                    ...
                    //url: 'OptReportsAB2.aspx/GetAbnormal',
                    method: 'post',
                    //contentType: "application/json; charset=utf-8",
                    //processData:false,
                    dataType: 'json',
