<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddVehicleHW.aspx.cs" MasterPageFile="~/Default_custom.Master" Inherits="PresentationLayer.Admin.Employee.AdddVehicleHW" %>
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div
                        ...
                        <div class="form-group row mx-0 mb-3 align-items-md-center">
                            ...
                            <asp:DropDownList
                                CssClass="form-control  col-md-12 col-lg-10 col-xl-8"
                                runat="server"
                                ID="ddlCargo">
                            </asp:DropDownList>
