<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditPayment.aspx.cs"
MasterPageFile="~/Default_admin.Master"
Inherits="PresentationLayer.Admin.AuditPayment" %> <%@ MasterType
          ...
          <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap px-4">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
              ...
              <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-dark">Permit Payment</li>
              </ul>
              <!--end::Breadcrumb-->
            </div>
            <!--end::Info-->
                  ...
                  <div class="card-body d-flex justify-content-between flex-column">
                    ...
                    <div id="table__responsive_Wrapper">
                      <asp:GridView ID="gvDept"
                          CssClass="table table-row-bordered table__bordered table__bordered_td_radio table-row-gray-300 border-0 gy-2 mb-1 display" runat="server"
                        AutoGenerateColumns="false" Width="100%" AlternatingRowStyle-CssClass="AlternateItemStyle"
                        HeaderStyle-CssClass="HeaderDatagrid fw-bold fs-6 text-gray-800 border-bottom border-gray-200 table_header" PageSize="10" OnRowDataBound="gvRowDataBound"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="Payment_Trans_No" HeaderText="Trans NO" />
                          <asp:BoundField DataField="Application_No" HeaderText="Application" />
                          <asp:BoundField DataField="Payment_Type" HeaderText="Payment Mode" />
                          <asp:BoundField DataField="Amount" HeaderText="Amount (TZS)" />
                          <asp:BoundField DataField="Message" HeaderText="Message" />
                          <asp:BoundField DataField="Response" HeaderText="Payment Status" />
